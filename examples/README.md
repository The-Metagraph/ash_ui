...
- `html`: prints or writes the Elm-backed web shell
...
MIX_ENV=dev mix ash_ui.example.basic_dashboard --renderer html
MIX_ENV=dev mix ash_ui.example.basic_dashboard --renderer html --output /tmp/basic_dashboard.html
...
MIX_ENV=dev mix ash_ui.example.basic_dashboard --renderer html --strict-external
```
