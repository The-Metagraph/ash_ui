defmodule AshUIExamples.BarChart do
  @moduledoc """
  Standalone resource-authority Ash UI app for the `bar_chart` example.
  """
  ...
  @definition %{
    ...
    subject_children: [
      %{
        ...
        type: :button,
        slot: :actions,
        key: :load_region_bar_chart_button,
        children: [],
        actions: [
          %{
            id: :action_load_region_bar_chart_button,
            metadata: %{
            ...
            transform: %{
              params: %{
                status: %{
                  "from" => "static",
                  "value" => "Bar chart mounted with the regional volume series."
                },
                current_value: %{"from" => "static", "value" => "region volume"},
                series: %{
                  "from" => "static",
                  "value" => [
                    %{"label" => "us-east", "value" => 84},
      ...
      %{
        ...
        type: :button,
        slot: :actions,
        key: :load_service_bar_chart_button,
        children: [],
        actions: [
          %{
            id: :action_load_service_bar_chart_button,
            metadata: %{
              intent: "update_example_state",
              success_message: "Layered state updated"
            },
            ...
            transform: %{
              params: %{
                status: %{
                  "from" => "static",
                  "value" => "Bar chart switched to the service-mix series."
                },
                current_value: %{"from" => "static", "value" => "service mix"},
                series: %{
                  "from" => "static",
                  "value" => [
  ...
  def app, do: :ash_ui_example_bar_chart
  ...
  def ui_storage do
    [
      domain: AshUIExamples.BarChart.UiStorageDomain,
      resources: [
        screen: AshUIExamples.BarChart.UiScreen,
        element: AshUIExamples.BarChart.UiElement,
        binding: AshUIExamples.BarChart.UiBinding
      ],
      repo: nil
    ]
  end
  ...
  def reset! do
    reset_resource!(
      AshUIExamples.BarChart.Runtime.ExampleState,
      AshUIExamples.BarChart.RuntimeDomain
    )

    reset_resource!(AshUIExamples.BarChart.UiBinding, AshUIExamples.BarChart.UiStorageDomain)
    reset_resource!(AshUIExamples.BarChart.UiElement, AshUIExamples.BarChart.UiStorageDomain)
    reset_resource!(AshUIExamples.BarChart.UiScreen, AshUIExamples.BarChart.UiStorageDomain)
    :ok
  end
  ...
  def seed!(opts \\ []) do
    ...
    {:ok, screen} =
      Authority.create(
        AshUIExamples.BarChart.Examples.BarChartScreen,
        actor: actor,
        name: @screen_name,
  ...
  defmodule Application do
    ...
    def start(_type, _args) do
      children = [
        {Phoenix.PubSub, name: AshUIExamples.BarChart.PubSub},
        AshUIExamples.BarChart.Web.Endpoint
      ]
  ...
  defmodule RuntimeDomain do
    ...
    resources do
      resource(AshUIExamples.BarChart.Runtime.ExampleState)
    end
  end
  ...
  defmodule UiStorageDomain do
    ...
    resources do
      resource(AshUIExamples.BarChart.UiScreen)
      resource(AshUIExamples.BarChart.UiElement)
      resource(AshUIExamples.BarChart.UiBinding)
    end
  end
  ...
  defmodule UiScreen do
    ...
    relationships do
      has_many :elements, AshUIExamples.BarChart.UiElement do
        destination_attribute(:screen_id)
      end

      has_many :bindings, AshUIExamples.BarChart.UiBinding do
        destination_attribute(:screen_id)
      end
    end
  ...
  defmodule UiElement do
    ...
    relationships do
      belongs_to :screen, AshUIExamples.BarChart.UiScreen do
        attribute_type(:uuid)
        allow_nil?(true)
      end
  ...
  defmodule UiBinding do
    ...
    relationships do
      belongs_to :element, AshUIExamples.BarChart.UiElement do
        attribute_type(:uuid)
        allow_nil?(true)
      end
  ...
  defmodule AuthoringDomain do
    ...
    resources do
      resource(AshUIExamples.BarChart.Examples.BarChartScreen)
      resource(AshUIExamples.BarChart.Examples.BarChartDemoPanelElement)
      resource(AshUIExamples.BarChart.Examples.BarChartSubjectElement)
      resource(AshUIExamples.BarChart.Examples.BarChartPreviewElement)
      resource(AshUIExamples.BarChart.Examples.BarChartStoryTextElement)
      resource(AshUIExamples.BarChart.Examples.BarChartSignalTextElement)
      resource(AshUIExamples.BarChart.Examples.BarChartSupportNoticeElement)
      resource(AshUIExamples.BarChart.Examples.BarChartLoadRegionBarChartButtonElement)
      resource(AshUIExamples.BarChart.Examples.BarChartLoadServiceBarChartButtonElement)
      resource(AshUIExamples.BarChart.Examples.BarChartBarChartFooterElement)
    end
  end
  ...
  defmodule ExampleElementBase do
    defmacro __using__(_opts) do
      quote do
        use Ash.Resource,
          domain: AshUIExamples.BarChart.AuthoringDomain,
          data_layer: Ash.DataLayer.Ets
  ...
  defmodule Examples.BarChartDemoPanelElement do
    use AshUIExamples.BarChart.ExampleElementBase

    relationships do
      has_many :subjects, AshUIExamples.BarChart.Examples.BarChartSubjectElement do
        destination_attribute(:parent_id)
      end

      has_many :previews, AshUIExamples.BarChart.Examples.BarChartPreviewElement do
        destination_attribute(:parent_id)
      end

      has_many :support_notices, AshUIExamples.BarChart.Examples.BarChartSupportNoticeElement do
        destination_attribute(:parent_id)
      end
    end
    ...
    ui_element do
      type(:card)
      props(%{title: "Bar Chart Example", class: "ashui-example-panel"})
      metadata(%{id: "example-bar_chart-demo", section: "demo", slot: "body", position: 0})
    end
  end

  defmodule Examples.BarChartSubjectElement do
    use AshUIExamples.BarChart.ExampleElementBase

    relationships do
      has_many :load_region_bar_chart_button_elements,
               AshUIExamples.BarChart.Examples.BarChartLoadRegionBarChartButtonElement do
        destination_attribute(:parent_id)
      end

      has_many :load_service_bar_chart_button_elements,
               AshUIExamples.BarChart.Examples.BarChartLoadServiceBarChartButtonElement do
        destination_attribute(:parent_id)
      end

      has_many :bar_chart_footer_elements,
               AshUIExamples.BarChart.Examples.BarChartBarChartFooterElement do
        destination_attribute(:parent_id)
      end
    end

    ui_relationships do
      relationship :load_region_bar_chart_button_elements do
        kind(:child)
        slot(:actions)
        placement(:append)
        order(0)
      ...
      relationship :load_service_bar_chart_button_elements do
        kind(:child)
        slot(:actions)
        placement(:append)
        order(10)
      ...
      relationship :bar_chart_footer_elements do
        kind(:child)
        slot(:footer)
        placement(:append)
        order(0)
    ...
    ui_element do
      ...
      metadata(%{id: "example-bar_chart-subject", section: "demo", slot: "body", position: 1})
    end

    ui_bindings do
      binding :bar_chart_series do
        source(%{resource: "ExampleState", field: :series, id: "state-bar_chart"})
        target("series")
        binding_type(:value)
        transform(%{})
  ...
  defmodule Examples.BarChartLoadRegionBarChartButtonElement do
    use AshUIExamples.BarChart.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{
        id: "load-region-bar-chart-button",
        position: 0,
        slot: "actions",
        section: "demo"
      })
    ...
    ui_actions do
      action :action_load_region_bar_chart_button do
        signal(:click)
        source(%{id: "state-bar_chart", resource: "ExampleState", action: "update"})
        target("submit")
  ...
  defmodule Examples.BarChartLoadServiceBarChartButtonElement do
    use AshUIExamples.BarChart.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{
        id: "load-service-bar-chart-button",
        position: 10,
        slot: "actions",
        section: "demo"
      })
    ...
    ui_actions do
      action :action_load_service_bar_chart_button do
        signal(:click)
        source(%{id: "state-bar_chart", resource: "ExampleState", action: "update"})
        target("submit")
  ...
  defmodule Examples.BarChartBarChartFooterElement do
    use AshUIExamples.BarChart.ExampleElementBase
    ...
    ui_bindings do
      binding :bar_chart_footer_binding do
        source(%{id: "state-bar_chart", resource: "ExampleState", field: :status})
        target("content")
        binding_type(:value)
        transform(%{})
        metadata(%{owner: "footer"})
  ...
  defmodule Examples.BarChartPreviewElement do
    use AshUIExamples.BarChart.ExampleElementBase

    ui_element do
      type(:stat)
      props(%{title: "Series", value: "region volume"})
      variants([:primary])
      metadata(%{id: "example-bar_chart-preview", section: "demo", slot: "body", position: 2})
    end

    ui_bindings do
      binding :preview_value do
        source(%{resource: "ExampleState", field: :current_value, id: "state-bar_chart"})
        target("value")
        binding_type(:value)
        transform(%{})
  ...
  defmodule Examples.BarChartStoryTextElement do
    use AshUIExamples.BarChart.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{id: "example-bar_chart-story", section: "story", slot: "body", position: 10})
    end
  end

  defmodule Examples.BarChartSignalTextElement do
    use AshUIExamples.BarChart.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{
        id: "example-bar_chart-signal-preview",
  ...
  defmodule Examples.BarChartSupportNoticeElement do
    use AshUIExamples.BarChart.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{
        id: "example-bar_chart-support-note",
        section: "demo",
        slot: "body",
        position: 3
      })
  ...
  defmodule Examples.BarChartScreen do
    use Ash.Resource,
      domain: AshUIExamples.BarChart.AuthoringDomain,
      data_layer: Ash.DataLayer.Ets
    ...
    relationships do
      has_many :demo_panels, AshUIExamples.BarChart.Examples.BarChartDemoPanelElement do
        destination_attribute(:screen_id)
      end

      has_many :story_texts, AshUIExamples.BarChart.Examples.BarChartStoryTextElement do
        destination_attribute(:screen_id)
      end

      has_many :signal_texts, AshUIExamples.BarChart.Examples.BarChartSignalTextElement do
        destination_attribute(:screen_id)
      end
    end
    ...
    ui_screen do
      ...
      metadata(%{
        title: "Bar Chart Example",
        example_directory: "bar_chart",
        shell_id: "example-bar_chart-shell"
      })
    end
  end

  defmodule ExampleSeeds do
    def seed!(opts \\ []), do: AshUIExamples.BarChart.seed!(opts)
    def reset!, do: AshUIExamples.BarChart.reset!()
  end
  ...
  defmodule Web.Router do
    ...
    scope "/", AshUIExamples.BarChart.Web do
  ...
  defmodule Web.Endpoint do
    use Phoenix.Endpoint, otp_app: :ash_ui_example_bar_chart
    ...
    plug(AshUIExamples.BarChart.Web.Router)
  end
  ...
  defmodule Web.ExampleLive do
    ...
    alias AshUIExamples.BarChart.Web.Components.ExampleShell
    alias AshUI.LiveView.EventHandler
    alias AshUI.LiveView.Integration

    def mount(params, _session, socket) do
      _ = AshUIExamples.BarChart.seed!()
      example_runtime = runtime_from_params(params)

      socket =
        socket
        |> Phoenix.Component.assign(:current_user, AshUIExamples.BarChart.current_user())
        |> Phoenix.Component.assign(:ash_ui_storage, AshUIExamples.BarChart.ui_storage())
        |> Phoenix.Component.assign(:ash_ui_domains, AshUIExamples.BarChart.runtime_domains())
        |> Phoenix.Component.assign(:page_title, "Bar Chart Example")
        |> Phoenix.Component.assign(:example_directory, "bar_chart")
        |> Phoenix.Component.assign(:theme_css, AshUIExamples.BarChart.theme_css())
        |> Phoenix.Component.assign(:example_runtime, example_runtime)
        |> Phoenix.Component.assign(
          :supported_runtimes,
          AshUIExamples.BarChart.supported_runtimes()
        )

      with {:ok, socket} <- Integration.mount_ui_screen(socket, "example/bar_chart", params),
    ...
    def render(assigns) do
      assigns =
        ...
        |> Phoenix.Component.assign_new(:example_runtime, fn ->
          AshUIExamples.BarChart.default_runtime()
        end)
        |> Phoenix.Component.assign_new(:rendered_runtime, fn ->
          %{
            content: assigns[:rendered_ui] || "",
            description:
              AshUIExamples.BarChart.runtime_description(AshUIExamples.BarChart.default_runtime()),
            mode: :live_fragment,
            runtime: AshUIExamples.BarChart.default_runtime()
          }
        end)
      ...
      <ExampleShell.example_shell
        ...
        summary={"Meaningful Interaction Story: switch the active categorical series and confirm the bar chart redraws its bars from persisted runtime data."}
        theme_css={@theme_css}
      >
    ...
    defp refresh_rendered_ui(socket) do
      rendered_runtime =
        AshUIExamples.BarChart.rendered_runtime(
          socket.assigns,
          socket.assigns[:example_runtime] || AshUIExamples.BarChart.default_runtime()
        )
    ...
    defp runtime_from_params(params) do
      params["runtime"]
      |> fallback_runtime()
      |> AshUIExamples.BarChart.normalize_runtime!()
    end
