defmodule AshUIExamples.Checkbox do
  @moduledoc """
  Standalone resource-authority Ash UI app for the `checkbox` example.
  """
  ...
  def app, do: :ash_ui_example_checkbox
  ...
  def runtime_domains, do: [AshUIExamples.Checkbox.RuntimeDomain]

  def current_user,
    do: %{active: true, id: "reviewer-checkbox", name: "Example Reviewer", role: :admin}
  ...
  def reset! do
    reset_resource!(
      AshUIExamples.Checkbox.Runtime.ExampleState,
      AshUIExamples.Checkbox.RuntimeDomain
    )

    reset_resource!(AshUIExamples.Checkbox.UiBinding, AshUIExamples.Checkbox.UiStorageDomain)
    reset_resource!(AshUIExamples.Checkbox.UiElement, AshUIExamples.Checkbox.UiStorageDomain)
    reset_resource!(AshUIExamples.Checkbox.UiScreen, AshUIExamples.Checkbox.UiStorageDomain)
    :ok
  end
  ...
  def seed!(opts \\ []) do
    ...
    {:ok, _state} =
      Ash.create(
        AshUIExamples.Checkbox.Runtime.ExampleState,
        seed_state(),
        domain: AshUIExamples.Checkbox.RuntimeDomain,
        authorize?: false
      )

    {:ok, screen} =
      Authority.create(
        AshUIExamples.Checkbox.Examples.CheckboxScreen,
        actor: actor,
        name: @screen_name,
  ...
  defmodule Application do
    ...
    def start(_type, _args) do
      children = [
        {Phoenix.PubSub, name: AshUIExamples.Checkbox.PubSub},
        AshUIExamples.Checkbox.Web.Endpoint
      ]
  ...
  defmodule RuntimeDomain do
    ...
    resources do
      resource(AshUIExamples.Checkbox.Runtime.ExampleState)
    end
  end

  defmodule Runtime.ExampleState do
    use Ash.Resource, domain: AshUIExamples.Checkbox.RuntimeDomain, data_layer: Ash.DataLayer.Ets
  ...
  defmodule UiStorageDomain do
    ...
    resources do
      resource(AshUIExamples.Checkbox.UiScreen)
      resource(AshUIExamples.Checkbox.UiElement)
      resource(AshUIExamples.Checkbox.UiBinding)
    end
  end
  ...
  defmodule UiScreen do
    ...
    relationships do
      has_many :elements, AshUIExamples.Checkbox.UiElement do
        destination_attribute(:screen_id)
      end

      has_many :bindings, AshUIExamples.Checkbox.UiBinding do
        destination_attribute(:screen_id)
      end
    end
  ...
  defmodule UiElement do
    ...
    relationships do
      belongs_to :screen, AshUIExamples.Checkbox.UiScreen do
        attribute_type(:uuid)
        allow_nil?(true)
      end
  ...
  defmodule UiBinding do
    ...
    relationships do
      belongs_to :element, AshUIExamples.Checkbox.UiElement do
        attribute_type(:uuid)
        allow_nil?(true)
      end
  ...
  defmodule AuthoringDomain do
    ...
    resources do
      resource(AshUIExamples.Checkbox.Examples.CheckboxScreen)
      resource(AshUIExamples.Checkbox.Examples.CheckboxDemoPanelElement)
      resource(AshUIExamples.Checkbox.Examples.CheckboxSubjectElement)
      resource(AshUIExamples.Checkbox.Examples.CheckboxPreviewElement)
      resource(AshUIExamples.Checkbox.Examples.CheckboxStoryTextElement)
      resource(AshUIExamples.Checkbox.Examples.CheckboxSignalTextElement)
    end
  end
  ...
  defmodule ExampleElementBase do
    defmacro __using__(_opts) do
      quote do
        use Ash.Resource,
          domain: AshUIExamples.Checkbox.AuthoringDomain,
          data_layer: Ash.DataLayer.Ets
  ...
  defmodule Examples.CheckboxDemoPanelElement do
    use AshUIExamples.Checkbox.ExampleElementBase

    relationships do
      has_many :subjects, AshUIExamples.Checkbox.Examples.CheckboxSubjectElement do
        destination_attribute(:parent_id)
      end

      has_many :previews, AshUIExamples.Checkbox.Examples.CheckboxPreviewElement do
        destination_attribute(:parent_id)
      end
    end
    ...
    ui_element do
      type(:card)
      props(%{title: "Checkbox Example", class: "ashui-example-panel"})
      metadata(%{id: "example-checkbox-demo", section: "demo", slot: "body", position: 0})
    end
  end

  defmodule Examples.CheckboxSubjectElement do
    use AshUIExamples.Checkbox.ExampleElementBase

    ui_element do
      type(:checkbox)
      props(%{name: "receive_updates", class: "ashui-example-checkbox", checked: true})
      metadata(%{id: "example-checkbox-subject", section: "demo", slot: "body", position: 1})
    end

    ui_bindings do
      binding :checkbox_value do
        source(%{resource: "ExampleState", field: :checked, id: "state-checkbox"})
        target("checked")
        binding_type(:value)
        transform(%{})
  ...
  defmodule Examples.CheckboxPreviewElement do
    use AshUIExamples.Checkbox.ExampleElementBase

    ui_element do
      type(:stat)
      props(%{title: "Checked state", value: true})
      variants([:primary])
      metadata(%{id: "example-checkbox-preview", section: "demo", slot: "body", position: 2})
    end
  ...
  defmodule Examples.CheckboxStoryTextElement do
    use AshUIExamples.Checkbox.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{id: "example-checkbox-story", section: "story", slot: "body", position: 10})
    end
  end

  defmodule Examples.CheckboxSignalTextElement do
    use AshUIExamples.Checkbox.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{
        id: "example-checkbox-signal-preview",
  ...
  defmodule Examples.CheckboxScreen do
    use Ash.Resource,
      domain: AshUIExamples.Checkbox.AuthoringDomain,
      data_layer: Ash.DataLayer.Ets
    ...
    relationships do
      has_many :demo_panels, AshUIExamples.Checkbox.Examples.CheckboxDemoPanelElement do
        destination_attribute(:screen_id)
      end

      has_many :story_texts, AshUIExamples.Checkbox.Examples.CheckboxStoryTextElement do
        destination_attribute(:screen_id)
      end

      has_many :signal_texts, AshUIExamples.Checkbox.Examples.CheckboxSignalTextElement do
        destination_attribute(:screen_id)
      end
    end
    ...
    ui_screen do
      ...
      metadata(%{
        title: "Checkbox Example",
        example_directory: "checkbox",
        shell_id: "example-checkbox-shell"
      })
    end
  end

  defmodule ExampleSeeds do
    def seed!(opts \\ []), do: AshUIExamples.Checkbox.seed!(opts)
    def reset!, do: AshUIExamples.Checkbox.reset!()
  end
  ...
  defmodule Web.Router do
    ...
    scope "/", AshUIExamples.Checkbox.Web do
  ...
  defmodule Web.Endpoint do
    use Phoenix.Endpoint, otp_app: :ash_ui_example_checkbox
    ...
    plug(AshUIExamples.Checkbox.Web.Router)
  end
  ...
  defmodule Web.ExampleLive do
    ...
    alias AshUIExamples.Checkbox.Web.Components.ExampleShell
    alias AshUI.LiveView.EventHandler
    alias AshUI.LiveView.Integration

    def mount(params, _session, socket) do
      _ = AshUIExamples.Checkbox.seed!()
      example_runtime = runtime_from_params(params)

      socket =
        socket
        |> Phoenix.Component.assign(:current_user, AshUIExamples.Checkbox.current_user())
        |> Phoenix.Component.assign(:ash_ui_storage, AshUIExamples.Checkbox.ui_storage())
        |> Phoenix.Component.assign(:ash_ui_domains, AshUIExamples.Checkbox.runtime_domains())
        |> Phoenix.Component.assign(:page_title, "Checkbox Example")
        |> Phoenix.Component.assign(:example_directory, "checkbox")
        |> Phoenix.Component.assign(:theme_css, AshUIExamples.Checkbox.theme_css())
        |> Phoenix.Component.assign(:example_runtime, example_runtime)
        |> Phoenix.Component.assign(
          :supported_runtimes,
          AshUIExamples.Checkbox.supported_runtimes()
        )

      with {:ok, socket} <- Integration.mount_ui_screen(socket, "example/checkbox", params),
    ...
    def render(assigns) do
      assigns =
        ...
        |> Phoenix.Component.assign_new(:example_runtime, fn ->
          AshUIExamples.Checkbox.default_runtime()
        end)
        |> Phoenix.Component.assign_new(:rendered_runtime, fn ->
          %{
            content: assigns[:rendered_ui] || "",
            description:
              AshUIExamples.Checkbox.runtime_description(AshUIExamples.Checkbox.default_runtime()),
            mode: :live_fragment,
            runtime: AshUIExamples.Checkbox.default_runtime()
          }
        end)
      ...
      <ExampleShell.example_shell
        ...
        summary={"Meaningful Interaction Story: toggle the checkbox and confirm the preview stat tracks the boolean state through an element-local binding."}
        theme_css={@theme_css}
      >
    ...
    defp refresh_rendered_ui(socket) do
      rendered_runtime =
        AshUIExamples.Checkbox.rendered_runtime(
          socket.assigns,
          socket.assigns[:example_runtime] || AshUIExamples.Checkbox.default_runtime()
        )
    ...
    defp runtime_from_params(params) do
      params["runtime"]
      |> fallback_runtime()
      |> AshUIExamples.Checkbox.normalize_runtime!()
    end
