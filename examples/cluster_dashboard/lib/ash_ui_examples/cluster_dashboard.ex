defmodule AshUIExamples.ClusterDashboard do
  @moduledoc """
  Standalone resource-authority Ash UI app for the `cluster_dashboard` example.
  """
  ...
  @screen_name "example/cluster_dashboard"
  @definition %{
    directory: "cluster_dashboard",
    family: :operational,
    ...
    seed_state: %{
      ...
      payload: %{
        ...
        "regions" => [
          %{"label" => "us-east", "load" => "63%", "status" => "Healthy"},
    ...
    subject_children: [
      %{
        ...
        type: :button,
        slot: :actions,
        key: :load_stable_cluster_dashboard_button,
        children: [],
        actions: [
          %{
            id: :action_load_stable_cluster_dashboard_button,
            metadata: %{
              ...
              params: %{
                ...
                payload: %{
                  ...
                  "value" => %{
                    "alerts" => [
                      %{
                        "message" => "Watching retriable writes.",
                        "title" => "Billing lag"
                      },
                      %{
                        "message" => "Trending down after rebalance.",
      ...
      %{
        ...
        type: :button,
        slot: :actions,
        key: :load_incident_cluster_dashboard_button,
        children: [],
        actions: [
          %{
            id: :action_load_incident_cluster_dashboard_button,
            metadata: %{
              intent: "update_example_state",
              success_message: "Layered state updated"
            },
              ...
              params: %{
                ...
                payload: %{
                  ...
                  "value" => %{
                    "alerts" => [
                      %{
                        "message" => "Crossed the paging threshold.",
      ...
      %{
        ...
        bindings: [
          %{
            id: :cluster_dashboard_footer_binding,
  ...
  def app, do: :ash_ui_example_cluster_dashboard
  ...
  def reset! do
    reset_resource!(
      AshUIExamples.ClusterDashboard.Runtime.ExampleState,
      AshUIExamples.ClusterDashboard.RuntimeDomain
    )

    reset_resource!(
      AshUIExamples.ClusterDashboard.UiBinding,
      AshUIExamples.ClusterDashboard.UiStorageDomain
    )

    reset_resource!(
      AshUIExamples.ClusterDashboard.UiElement,
      AshUIExamples.ClusterDashboard.UiStorageDomain
    )

    reset_resource!(
      AshUIExamples.ClusterDashboard.UiScreen,
      AshUIExamples.ClusterDashboard.UiStorageDomain
    )
  ...
  def seed!(opts \\ []) do
    ...
    {:ok, screen} =
      Authority.create(
        AshUIExamples.ClusterDashboard.Examples.ClusterDashboardScreen,
        actor: actor,
        name: @screen_name,
  ...
  defmodule Application do
    ...
    def start(_type, _args) do
      children = [
        {Phoenix.PubSub, name: AshUIExamples.ClusterDashboard.PubSub},
        AshUIExamples.ClusterDashboard.Web.Endpoint
      ]
  ...
  defmodule RuntimeDomain do
    ...
    resources do
      resource(AshUIExamples.ClusterDashboard.Runtime.ExampleState)
    end
  end
  ...
  defmodule UiStorageDomain do
    ...
    resources do
      resource(AshUIExamples.ClusterDashboard.UiScreen)
      resource(AshUIExamples.ClusterDashboard.UiElement)
      resource(AshUIExamples.ClusterDashboard.UiBinding)
    end
  end
  ...
  defmodule UiScreen do
    ...
    relationships do
      has_many :elements, AshUIExamples.ClusterDashboard.UiElement do
        destination_attribute(:screen_id)
      end

      has_many :bindings, AshUIExamples.ClusterDashboard.UiBinding do
        destination_attribute(:screen_id)
      end
    end
  ...
  defmodule UiElement do
    ...
    relationships do
      belongs_to :screen, AshUIExamples.ClusterDashboard.UiScreen do
        attribute_type(:uuid)
        allow_nil?(true)
      end
  ...
  defmodule UiBinding do
    ...
    relationships do
      belongs_to :element, AshUIExamples.ClusterDashboard.UiElement do
        attribute_type(:uuid)
        allow_nil?(true)
      end
  ...
  defmodule AuthoringDomain do
    ...
    resources do
      resource(AshUIExamples.ClusterDashboard.Examples.ClusterDashboardScreen)
      resource(AshUIExamples.ClusterDashboard.Examples.ClusterDashboardDemoPanelElement)
      resource(AshUIExamples.ClusterDashboard.Examples.ClusterDashboardSubjectElement)
      resource(AshUIExamples.ClusterDashboard.Examples.ClusterDashboardPreviewElement)
      resource(AshUIExamples.ClusterDashboard.Examples.ClusterDashboardStoryTextElement)
      resource(AshUIExamples.ClusterDashboard.Examples.ClusterDashboardSignalTextElement)
      resource(AshUIExamples.ClusterDashboard.Examples.ClusterDashboardSupportNoticeElement)

      resource(
        AshUIExamples.ClusterDashboard.Examples.ClusterDashboardLoadStableClusterDashboardButtonElement
      )

      resource(
        AshUIExamples.ClusterDashboard.Examples.ClusterDashboardLoadIncidentClusterDashboardButtonElement
      )

      resource(
        AshUIExamples.ClusterDashboard.Examples.ClusterDashboardClusterDashboardFooterElement
      )
    end
  end
  ...
  defmodule ExampleElementBase do
    defmacro __using__(_opts) do
      quote do
        use Ash.Resource,
          domain: AshUIExamples.ClusterDashboard.AuthoringDomain,
          data_layer: Ash.DataLayer.Ets
  ...
  defmodule Examples.ClusterDashboardDemoPanelElement do
    use AshUIExamples.ClusterDashboard.ExampleElementBase

    relationships do
      has_many :subjects,
               AshUIExamples.ClusterDashboard.Examples.ClusterDashboardSubjectElement do
        destination_attribute(:parent_id)
      end

      has_many :previews,
               AshUIExamples.ClusterDashboard.Examples.ClusterDashboardPreviewElement do
        destination_attribute(:parent_id)
      end

      has_many :support_notices,
               AshUIExamples.ClusterDashboard.Examples.ClusterDashboardSupportNoticeElement do
        destination_attribute(:parent_id)
      end
    end
    ...
    ui_element do
      type(:card)
      props(%{title: "Cluster Dashboard Example", class: "ashui-example-panel"})

      metadata(%{
        id: "example-cluster_dashboard-demo",
        section: "demo",
        slot: "body",
        position: 0
      })
  ...
  defmodule Examples.ClusterDashboardSubjectElement do
    use AshUIExamples.ClusterDashboard.ExampleElementBase

    relationships do
      has_many :load_stable_cluster_dashboard_button_elements,
               AshUIExamples.ClusterDashboard.Examples.ClusterDashboardLoadStableClusterDashboardButtonElement do
        destination_attribute(:parent_id)
      end

      has_many :load_incident_cluster_dashboard_button_elements,
               AshUIExamples.ClusterDashboard.Examples.ClusterDashboardLoadIncidentClusterDashboardButtonElement do
        destination_attribute(:parent_id)
      end

      has_many :cluster_dashboard_footer_elements,
               AshUIExamples.ClusterDashboard.Examples.ClusterDashboardClusterDashboardFooterElement do
        destination_attribute(:parent_id)
      end
    end

    ui_relationships do
      relationship :load_stable_cluster_dashboard_button_elements do
        kind(:child)
        slot(:actions)
        placement(:append)
        order(0)
      ...
      relationship :load_incident_cluster_dashboard_button_elements do
        kind(:child)
        slot(:actions)
        placement(:append)
        order(10)
      ...
      relationship :cluster_dashboard_footer_elements do
        kind(:child)
        slot(:footer)
        placement(:append)
        order(0)
    ...
    ui_element do
      ...
      metadata(%{
        id: "example-cluster_dashboard-subject",
        section: "demo",
        slot: "body",
        position: 1
      })
    ...
    ui_bindings do
      binding :cluster_dashboard_model do
        source(%{resource: "ExampleState", field: :payload, id: "state-cluster_dashboard"})
        target("model")
        binding_type(:value)
        transform(%{})
  ...
  defmodule Examples.ClusterDashboardLoadStableClusterDashboardButtonElement do
    use AshUIExamples.ClusterDashboard.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{
        id: "load-stable-cluster-dashboard-button",
        position: 0,
        slot: "actions",
        section: "demo"
      })
    ...
    ui_actions do
      action :action_load_stable_cluster_dashboard_button do
        signal(:click)
        source(%{id: "state-cluster_dashboard", resource: "ExampleState", action: "update"})
        target("submit")
  ...
  defmodule Examples.ClusterDashboardLoadIncidentClusterDashboardButtonElement do
    use AshUIExamples.ClusterDashboard.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{
        id: "load-incident-cluster-dashboard-button",
        position: 10,
        slot: "actions",
        section: "demo"
      })
    ...
    ui_actions do
      action :action_load_incident_cluster_dashboard_button do
        signal(:click)
        source(%{id: "state-cluster_dashboard", resource: "ExampleState", action: "update"})
        target("submit")
          ...
          params: %{
            ...
            payload: %{
              ...
              "value" => %{
                ...
                "headline" => "Regional cluster degraded",
                "regions" => [
                  %{"label" => "us-east", "load" => "87%", "status" => "Degraded"},
                  %{"label" => "us-west", "load" => "59%", "status" => "Healthy"},
  ...
  defmodule Examples.ClusterDashboardClusterDashboardFooterElement do
    use AshUIExamples.ClusterDashboard.ExampleElementBase
    ...
    ui_bindings do
      binding :cluster_dashboard_footer_binding do
        source(%{id: "state-cluster_dashboard", resource: "ExampleState", field: :status})
        target("content")
        binding_type(:value)
        transform(%{})
        metadata(%{owner: "footer"})
  ...
  defmodule Examples.ClusterDashboardPreviewElement do
    use AshUIExamples.ClusterDashboard.ExampleElementBase

    ui_element do
      type(:stat)
      props(%{title: "Snapshot", value: "stable cluster"})
      variants([:primary])

      metadata(%{
        id: "example-cluster_dashboard-preview",
        section: "demo",
        slot: "body",
        position: 2
      })
    ...
    ui_bindings do
      binding :preview_value do
        source(%{resource: "ExampleState", field: :current_value, id: "state-cluster_dashboard"})
        target("value")
        binding_type(:value)
        transform(%{})
  ...
  defmodule Examples.ClusterDashboardStoryTextElement do
    use AshUIExamples.ClusterDashboard.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{
        id: "example-cluster_dashboard-story",
        section: "story",
        slot: "body",
        position: 10
      })
  ...
  defmodule Examples.ClusterDashboardSignalTextElement do
    use AshUIExamples.ClusterDashboard.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{
        id: "example-cluster_dashboard-signal-preview",
  ...
  defmodule Examples.ClusterDashboardSupportNoticeElement do
    use AshUIExamples.ClusterDashboard.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{
        id: "example-cluster_dashboard-support-note",
        section: "demo",
        slot: "body",
        position: 3
      })
  ...
  defmodule Examples.ClusterDashboardScreen do
    use Ash.Resource,
      domain: AshUIExamples.ClusterDashboard.AuthoringDomain,
      data_layer: Ash.DataLayer.Ets
    ...
    relationships do
      has_many :demo_panels,
               AshUIExamples.ClusterDashboard.Examples.ClusterDashboardDemoPanelElement do
        destination_attribute(:screen_id)
      end

      has_many :story_texts,
               AshUIExamples.ClusterDashboard.Examples.ClusterDashboardStoryTextElement do
        destination_attribute(:screen_id)
      end

      has_many :signal_texts,
               AshUIExamples.ClusterDashboard.Examples.ClusterDashboardSignalTextElement do
        destination_attribute(:screen_id)
      end
    end
    ...
    ui_screen do
      ...
      metadata(%{
        title: "Cluster Dashboard Example",
        example_directory: "cluster_dashboard",
        shell_id: "example-cluster_dashboard-shell"
      })
    end
  end

  defmodule ExampleSeeds do
    def seed!(opts \\ []), do: AshUIExamples.ClusterDashboard.seed!(opts)
    def reset!, do: AshUIExamples.ClusterDashboard.reset!()
  end
  ...
  defmodule Web.Router do
    ...
    scope "/", AshUIExamples.ClusterDashboard.Web do
  ...
  defmodule Web.Endpoint do
    use Phoenix.Endpoint, otp_app: :ash_ui_example_cluster_dashboard
    ...
    plug(AshUIExamples.ClusterDashboard.Web.Router)
  end
  ...
  defmodule Web.ExampleLive do
    ...
    alias AshUIExamples.ClusterDashboard.Web.Components.ExampleShell
    alias AshUI.LiveView.EventHandler
    alias AshUI.LiveView.Integration

    def mount(params, _session, socket) do
      _ = AshUIExamples.ClusterDashboard.seed!()
      example_runtime = runtime_from_params(params)

      socket =
        socket
        |> Phoenix.Component.assign(:current_user, AshUIExamples.ClusterDashboard.current_user())
        |> Phoenix.Component.assign(:ash_ui_storage, AshUIExamples.ClusterDashboard.ui_storage())
        |> Phoenix.Component.assign(
          :ash_ui_domains,
          AshUIExamples.ClusterDashboard.runtime_domains()
        )
        |> Phoenix.Component.assign(:page_title, "Cluster Dashboard Example")
        |> Phoenix.Component.assign(:example_directory, "cluster_dashboard")
        |> Phoenix.Component.assign(:theme_css, AshUIExamples.ClusterDashboard.theme_css())
        |> Phoenix.Component.assign(:example_runtime, example_runtime)
        |> Phoenix.Component.assign(
          :supported_runtimes,
          AshUIExamples.ClusterDashboard.supported_runtimes()
        )

      with {:ok, socket} <-
             Integration.mount_ui_screen(socket, "example/cluster_dashboard", params),
    ...
    def render(assigns) do
      assigns =
        ...
        |> Phoenix.Component.assign_new(:example_runtime, fn ->
          AshUIExamples.ClusterDashboard.default_runtime()
        end)
        |> Phoenix.Component.assign_new(:rendered_runtime, fn ->
          %{
            content: assigns[:rendered_ui] || "",
            description:
              AshUIExamples.ClusterDashboard.runtime_description(
                AshUIExamples.ClusterDashboard.default_runtime()
              ),
            mode: :live_fragment,
            runtime: AshUIExamples.ClusterDashboard.default_runtime()
          }
        end)
      ...
      <ExampleShell.example_shell
        ...
        summary={"Meaningful Interaction Story: switch the dashboard between stable and incident snapshots and confirm the headline, regional cards, and alert rail all update from persisted runtime data."}
        theme_css={@theme_css}
      >
    ...
    defp refresh_rendered_ui(socket) do
      rendered_runtime =
        AshUIExamples.ClusterDashboard.rendered_runtime(
          socket.assigns,
          socket.assigns[:example_runtime] || AshUIExamples.ClusterDashboard.default_runtime()
        )
    ...
    defp runtime_from_params(params) do
      params["runtime"]
      |> fallback_runtime()
      |> AshUIExamples.ClusterDashboard.normalize_runtime!()
    end
