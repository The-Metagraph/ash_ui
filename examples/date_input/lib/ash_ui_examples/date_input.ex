defmodule AshUIExamples.DateInput do
  @moduledoc """
  Standalone resource-authority Ash UI app for the `date_input` example.
  """
  ...
  @screen_name "example/date_input"
  @definition %{
    directory: "date_input",
    family: :input,
  ...
  def app, do: :ash_ui_example_date_input
  ...
  def runtime_domains, do: [AshUIExamples.DateInput.RuntimeDomain]

  def current_user,
    do: %{
      active: true,
      id: "reviewer-date_input",
  ...
  def reset! do
    reset_resource!(
      AshUIExamples.DateInput.Runtime.ExampleState,
      AshUIExamples.DateInput.RuntimeDomain
    )

    reset_resource!(AshUIExamples.DateInput.UiBinding, AshUIExamples.DateInput.UiStorageDomain)
    reset_resource!(AshUIExamples.DateInput.UiElement, AshUIExamples.DateInput.UiStorageDomain)
    reset_resource!(AshUIExamples.DateInput.UiScreen, AshUIExamples.DateInput.UiStorageDomain)
    :ok
  end
  ...
  def seed!(opts \\ []) do
    ...
    {:ok, _state} =
      Ash.create(
        AshUIExamples.DateInput.Runtime.ExampleState,
        seed_state(),
        domain: AshUIExamples.DateInput.RuntimeDomain,
        authorize?: false
      )

    {:ok, screen} =
      Authority.create(
        AshUIExamples.DateInput.Examples.DateInputScreen,
        actor: actor,
        name: @screen_name,
  ...
  defmodule Application do
    ...
    def start(_type, _args) do
      children = [
        {Phoenix.PubSub, name: AshUIExamples.DateInput.PubSub},
        AshUIExamples.DateInput.Web.Endpoint
      ]
  ...
  defmodule RuntimeDomain do
    ...
    resources do
      resource(AshUIExamples.DateInput.Runtime.ExampleState)
    end
  end

  defmodule Runtime.ExampleState do
    use Ash.Resource, domain: AshUIExamples.DateInput.RuntimeDomain, data_layer: Ash.DataLayer.Ets
  ...
  defmodule UiStorageDomain do
    ...
    resources do
      resource(AshUIExamples.DateInput.UiScreen)
      resource(AshUIExamples.DateInput.UiElement)
      resource(AshUIExamples.DateInput.UiBinding)
    end
  end
  ...
  defmodule UiScreen do
    ...
    relationships do
      has_many :elements, AshUIExamples.DateInput.UiElement do
        destination_attribute(:screen_id)
      end

      has_many :bindings, AshUIExamples.DateInput.UiBinding do
        destination_attribute(:screen_id)
      end
    end
  ...
  defmodule UiElement do
    ...
    relationships do
      belongs_to :screen, AshUIExamples.DateInput.UiScreen do
        attribute_type(:uuid)
        allow_nil?(true)
      end
  ...
  defmodule UiBinding do
    ...
    relationships do
      belongs_to :element, AshUIExamples.DateInput.UiElement do
        attribute_type(:uuid)
        allow_nil?(true)
      end
  ...
  defmodule AuthoringDomain do
    ...
    resources do
      resource(AshUIExamples.DateInput.Examples.DateInputScreen)
      resource(AshUIExamples.DateInput.Examples.DateInputDemoPanelElement)
      resource(AshUIExamples.DateInput.Examples.DateInputSubjectElement)
      resource(AshUIExamples.DateInput.Examples.DateInputPreviewElement)
      resource(AshUIExamples.DateInput.Examples.DateInputStoryTextElement)
      resource(AshUIExamples.DateInput.Examples.DateInputSignalTextElement)
    end
  end
  ...
  defmodule ExampleElementBase do
    defmacro __using__(_opts) do
      quote do
        use Ash.Resource,
          domain: AshUIExamples.DateInput.AuthoringDomain,
          data_layer: Ash.DataLayer.Ets
  ...
  defmodule Examples.DateInputDemoPanelElement do
    use AshUIExamples.DateInput.ExampleElementBase

    relationships do
      has_many :subjects, AshUIExamples.DateInput.Examples.DateInputSubjectElement do
        destination_attribute(:parent_id)
      end

      has_many :previews, AshUIExamples.DateInput.Examples.DateInputPreviewElement do
        destination_attribute(:parent_id)
      end
    end
    ...
    ui_element do
      type(:card)
      props(%{title: "Date Input Example", class: "ashui-example-panel"})
      metadata(%{id: "example-date_input-demo", section: "demo", slot: "body", position: 0})
    end
  end

  defmodule Examples.DateInputSubjectElement do
    use AshUIExamples.DateInput.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{id: "example-date_input-subject", section: "demo", slot: "body", position: 1})
    end

    ui_bindings do
      binding :date_input_value do
        source(%{resource: "ExampleState", field: :current_value, id: "state-date_input"})
        target("value")
        binding_type(:value)
        transform(%{})
  ...
  defmodule Examples.DateInputPreviewElement do
    use AshUIExamples.DateInput.ExampleElementBase

    ui_element do
      type(:stat)
      props(%{title: "Selected date", value: "2026-04-24"})
      variants([:primary])
      metadata(%{id: "example-date_input-preview", section: "demo", slot: "body", position: 2})
    end
  ...
  defmodule Examples.DateInputStoryTextElement do
    use AshUIExamples.DateInput.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{id: "example-date_input-story", section: "story", slot: "body", position: 10})
    end
  end

  defmodule Examples.DateInputSignalTextElement do
    use AshUIExamples.DateInput.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{
        id: "example-date_input-signal-preview",
  ...
  defmodule Examples.DateInputScreen do
    use Ash.Resource,
      domain: AshUIExamples.DateInput.AuthoringDomain,
      data_layer: Ash.DataLayer.Ets
    ...
    relationships do
      has_many :demo_panels, AshUIExamples.DateInput.Examples.DateInputDemoPanelElement do
        destination_attribute(:screen_id)
      end

      has_many :story_texts, AshUIExamples.DateInput.Examples.DateInputStoryTextElement do
        destination_attribute(:screen_id)
      end

      has_many :signal_texts, AshUIExamples.DateInput.Examples.DateInputSignalTextElement do
        destination_attribute(:screen_id)
      end
    end
    ...
    ui_screen do
      ...
      metadata(%{
        title: "Date Input Example",
        example_directory: "date_input",
        shell_id: "example-date_input-shell"
      })
    end
  end

  defmodule ExampleSeeds do
    def seed!(opts \\ []), do: AshUIExamples.DateInput.seed!(opts)
    def reset!, do: AshUIExamples.DateInput.reset!()
  end
  ...
  defmodule Web.Router do
    ...
    scope "/", AshUIExamples.DateInput.Web do
  ...
  defmodule Web.Endpoint do
    use Phoenix.Endpoint, otp_app: :ash_ui_example_date_input
    ...
    plug(AshUIExamples.DateInput.Web.Router)
  end
  ...
  defmodule Web.ExampleLive do
    ...
    alias AshUIExamples.DateInput.Web.Components.ExampleShell
    alias AshUI.LiveView.EventHandler
    alias AshUI.LiveView.Integration

    def mount(params, _session, socket) do
      _ = AshUIExamples.DateInput.seed!()
      example_runtime = runtime_from_params(params)

      socket =
        socket
        |> Phoenix.Component.assign(:current_user, AshUIExamples.DateInput.current_user())
        |> Phoenix.Component.assign(:ash_ui_storage, AshUIExamples.DateInput.ui_storage())
        |> Phoenix.Component.assign(:ash_ui_domains, AshUIExamples.DateInput.runtime_domains())
        |> Phoenix.Component.assign(:page_title, "Date Input Example")
        |> Phoenix.Component.assign(:example_directory, "date_input")
        |> Phoenix.Component.assign(:theme_css, AshUIExamples.DateInput.theme_css())
        |> Phoenix.Component.assign(:example_runtime, example_runtime)
        |> Phoenix.Component.assign(
          :supported_runtimes,
          AshUIExamples.DateInput.supported_runtimes()
        )

      with {:ok, socket} <- Integration.mount_ui_screen(socket, "example/date_input", params),
    ...
    def render(assigns) do
      assigns =
        ...
        |> Phoenix.Component.assign_new(:example_runtime, fn ->
          AshUIExamples.DateInput.default_runtime()
        end)
        |> Phoenix.Component.assign_new(:rendered_runtime, fn ->
          %{
            content: assigns[:rendered_ui] || "",
            description:
              AshUIExamples.DateInput.runtime_description(
                AshUIExamples.DateInput.default_runtime()
              ),
            mode: :live_fragment,
            runtime: AshUIExamples.DateInput.default_runtime()
          }
        end)
      ...
      <ExampleShell.example_shell
        ...
        summary={"Meaningful Interaction Story: choose a date and confirm the preview stat reflects the authored input state inside the shared form-oriented shell."}
        theme_css={@theme_css}
      >
    ...
    defp refresh_rendered_ui(socket) do
      rendered_runtime =
        AshUIExamples.DateInput.rendered_runtime(
          socket.assigns,
          socket.assigns[:example_runtime] || AshUIExamples.DateInput.default_runtime()
        )
    ...
    defp runtime_from_params(params) do
      params["runtime"]
      |> fallback_runtime()
      |> AshUIExamples.DateInput.normalize_runtime!()
    end
