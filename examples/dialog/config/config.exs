...
config :ash_ui_example_dialog,
  ecto_repos: []

config :ash_ui_example_dialog, AshUIExamples.Dialog.Web.Endpoint,
  url: [host: "127.0.0.1"],
...
config :ash_ui, :ash_domains, [AshUIExamples.Dialog.RuntimeDomain]
