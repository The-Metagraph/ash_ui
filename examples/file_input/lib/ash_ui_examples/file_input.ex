defmodule AshUIExamples.FileInput do
  @moduledoc """
  Standalone resource-authority Ash UI app for the `file_input` example.
  """
  ...
  @screen_name "example/file_input"
  @definition %{
    directory: "file_input",
    family: :input,
  ...
  def app, do: :ash_ui_example_file_input
  ...
  def runtime_domains, do: [AshUIExamples.FileInput.RuntimeDomain]

  def current_user,
    do: %{
      active: true,
      id: "reviewer-file_input",
  ...
  def reset! do
    reset_resource!(
      AshUIExamples.FileInput.Runtime.ExampleState,
      AshUIExamples.FileInput.RuntimeDomain
    )

    reset_resource!(AshUIExamples.FileInput.UiBinding, AshUIExamples.FileInput.UiStorageDomain)
    reset_resource!(AshUIExamples.FileInput.UiElement, AshUIExamples.FileInput.UiStorageDomain)
    reset_resource!(AshUIExamples.FileInput.UiScreen, AshUIExamples.FileInput.UiStorageDomain)
    :ok
  end
  ...
  def seed!(opts \\ []) do
    ...
    {:ok, _state} =
      Ash.create(
        AshUIExamples.FileInput.Runtime.ExampleState,
        seed_state(),
        domain: AshUIExamples.FileInput.RuntimeDomain,
        authorize?: false
      )

    {:ok, screen} =
      Authority.create(
        AshUIExamples.FileInput.Examples.FileInputScreen,
        actor: actor,
        name: @screen_name,
  ...
  defmodule Application do
    ...
    def start(_type, _args) do
      children = [
        {Phoenix.PubSub, name: AshUIExamples.FileInput.PubSub},
        AshUIExamples.FileInput.Web.Endpoint
      ]
  ...
  defmodule RuntimeDomain do
    ...
    resources do
      resource(AshUIExamples.FileInput.Runtime.ExampleState)
    end
  end

  defmodule Runtime.ExampleState do
    use Ash.Resource, domain: AshUIExamples.FileInput.RuntimeDomain, data_layer: Ash.DataLayer.Ets
  ...
  defmodule UiStorageDomain do
    ...
    resources do
      resource(AshUIExamples.FileInput.UiScreen)
      resource(AshUIExamples.FileInput.UiElement)
      resource(AshUIExamples.FileInput.UiBinding)
    end
  end
  ...
  defmodule UiScreen do
    ...
    relationships do
      has_many :elements, AshUIExamples.FileInput.UiElement do
        destination_attribute(:screen_id)
      end

      has_many :bindings, AshUIExamples.FileInput.UiBinding do
        destination_attribute(:screen_id)
      end
    end
  ...
  defmodule UiElement do
    ...
    relationships do
      belongs_to :screen, AshUIExamples.FileInput.UiScreen do
        attribute_type(:uuid)
        allow_nil?(true)
      end
  ...
  defmodule UiBinding do
    ...
    relationships do
      belongs_to :element, AshUIExamples.FileInput.UiElement do
        attribute_type(:uuid)
        allow_nil?(true)
      end
  ...
  defmodule AuthoringDomain do
    ...
    resources do
      resource(AshUIExamples.FileInput.Examples.FileInputScreen)
      resource(AshUIExamples.FileInput.Examples.FileInputDemoPanelElement)
      resource(AshUIExamples.FileInput.Examples.FileInputSubjectElement)
      resource(AshUIExamples.FileInput.Examples.FileInputPreviewElement)
      resource(AshUIExamples.FileInput.Examples.FileInputStoryTextElement)
      resource(AshUIExamples.FileInput.Examples.FileInputSignalTextElement)
      resource(AshUIExamples.FileInput.Examples.FileInputSupportNoticeElement)
    end
  end
  ...
  defmodule ExampleElementBase do
    defmacro __using__(_opts) do
      quote do
        use Ash.Resource,
          domain: AshUIExamples.FileInput.AuthoringDomain,
          data_layer: Ash.DataLayer.Ets
  ...
  defmodule Examples.FileInputDemoPanelElement do
    use AshUIExamples.FileInput.ExampleElementBase

    relationships do
      has_many :subjects, AshUIExamples.FileInput.Examples.FileInputSubjectElement do
        destination_attribute(:parent_id)
      end

      has_many :previews, AshUIExamples.FileInput.Examples.FileInputPreviewElement do
        destination_attribute(:parent_id)
      end

      has_many :support_notices, AshUIExamples.FileInput.Examples.FileInputSupportNoticeElement do
        destination_attribute(:parent_id)
      end
    end
    ...
    ui_element do
      type(:card)
      props(%{title: "File Input Example", class: "ashui-example-panel"})
      metadata(%{id: "example-file_input-demo", section: "demo", slot: "body", position: 0})
    end
  end

  defmodule Examples.FileInputSubjectElement do
    use AshUIExamples.FileInput.ExampleElementBase

    ui_element do
      type(:input)
      props(%{name: "attachment", type: "file", class: "ashui-example-input"})
      metadata(%{id: "example-file_input-subject", section: "demo", slot: "body", position: 1})
    end

    ui_bindings do
      binding :file_input_value do
        source(%{resource: "ExampleState", field: :submitted_value, id: "state-file_input"})
        target("value")
        binding_type(:value)
        transform(%{})
  ...
  defmodule Examples.FileInputPreviewElement do
    use AshUIExamples.FileInput.ExampleElementBase

    ui_element do
      type(:stat)
      props(%{title: "Selected filename", value: "No file selected"})
      variants([:primary])
      metadata(%{id: "example-file_input-preview", section: "demo", slot: "body", position: 2})
    end
  ...
  defmodule Examples.FileInputStoryTextElement do
    use AshUIExamples.FileInput.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{id: "example-file_input-story", section: "story", slot: "body", position: 10})
    end
  end

  defmodule Examples.FileInputSignalTextElement do
    use AshUIExamples.FileInput.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{
        id: "example-file_input-signal-preview",
  ...
  defmodule Examples.FileInputSupportNoticeElement do
    use AshUIExamples.FileInput.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{
        id: "example-file_input-support-note",
        section: "demo",
        slot: "body",
        position: 3
      })
  ...
  defmodule Examples.FileInputScreen do
    use Ash.Resource,
      domain: AshUIExamples.FileInput.AuthoringDomain,
      data_layer: Ash.DataLayer.Ets
    ...
    relationships do
      has_many :demo_panels, AshUIExamples.FileInput.Examples.FileInputDemoPanelElement do
        destination_attribute(:screen_id)
      end

      has_many :story_texts, AshUIExamples.FileInput.Examples.FileInputStoryTextElement do
        destination_attribute(:screen_id)
      end

      has_many :signal_texts, AshUIExamples.FileInput.Examples.FileInputSignalTextElement do
        destination_attribute(:screen_id)
      end
    end
    ...
    ui_screen do
      ...
      metadata(%{
        title: "File Input Example",
        example_directory: "file_input",
        shell_id: "example-file_input-shell"
      })
    end
  end

  defmodule ExampleSeeds do
    def seed!(opts \\ []), do: AshUIExamples.FileInput.seed!(opts)
    def reset!, do: AshUIExamples.FileInput.reset!()
  end
  ...
  defmodule Web.Router do
    ...
    scope "/", AshUIExamples.FileInput.Web do
  ...
  defmodule Web.Endpoint do
    use Phoenix.Endpoint, otp_app: :ash_ui_example_file_input
    ...
    plug(AshUIExamples.FileInput.Web.Router)
  end
  ...
  defmodule Web.ExampleLive do
    ...
    alias AshUIExamples.FileInput.Web.Components.ExampleShell
    alias AshUI.LiveView.EventHandler
    alias AshUI.LiveView.Integration

    def mount(params, _session, socket) do
      _ = AshUIExamples.FileInput.seed!()
      example_runtime = runtime_from_params(params)

      socket =
        socket
        |> Phoenix.Component.assign(:current_user, AshUIExamples.FileInput.current_user())
        |> Phoenix.Component.assign(:ash_ui_storage, AshUIExamples.FileInput.ui_storage())
        |> Phoenix.Component.assign(:ash_ui_domains, AshUIExamples.FileInput.runtime_domains())
        |> Phoenix.Component.assign(:page_title, "File Input Example")
        |> Phoenix.Component.assign(:example_directory, "file_input")
        |> Phoenix.Component.assign(:theme_css, AshUIExamples.FileInput.theme_css())
        |> Phoenix.Component.assign(:example_runtime, example_runtime)
        |> Phoenix.Component.assign(
          :supported_runtimes,
          AshUIExamples.FileInput.supported_runtimes()
        )

      with {:ok, socket} <- Integration.mount_ui_screen(socket, "example/file_input", params),
    ...
    def render(assigns) do
      assigns =
        ...
        |> Phoenix.Component.assign_new(:example_runtime, fn ->
          AshUIExamples.FileInput.default_runtime()
        end)
        |> Phoenix.Component.assign_new(:rendered_runtime, fn ->
          %{
            content: assigns[:rendered_ui] || "",
            description:
              AshUIExamples.FileInput.runtime_description(
                AshUIExamples.FileInput.default_runtime()
              ),
            mode: :live_fragment,
            runtime: AshUIExamples.FileInput.default_runtime()
          }
        end)
      ...
      <ExampleShell.example_shell
        ...
        summary={"Meaningful Interaction Story: choose a representative filename and confirm the preview stat records the selection while the support note stays explicit that upload transport is not implemented here."}
        theme_css={@theme_css}
      >
    ...
    defp refresh_rendered_ui(socket) do
      rendered_runtime =
        AshUIExamples.FileInput.rendered_runtime(
          socket.assigns,
          socket.assigns[:example_runtime] || AshUIExamples.FileInput.default_runtime()
        )
    ...
    defp runtime_from_params(params) do
      params["runtime"]
      |> fallback_runtime()
      |> AshUIExamples.FileInput.normalize_runtime!()
    end
