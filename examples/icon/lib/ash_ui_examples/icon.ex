defmodule AshUIExamples.Icon do
  @moduledoc """
  Standalone resource-authority Ash UI app for the `icon` example.
  """
  ...
  def app, do: :ash_ui_example_icon
  ...
  def runtime_domains, do: [AshUIExamples.Icon.RuntimeDomain]

  def current_user,
    do: %{active: true, id: "reviewer-icon", name: "Example Reviewer", role: :admin}
  ...
  def reset! do
    reset_resource!(AshUIExamples.Icon.Runtime.ExampleState, AshUIExamples.Icon.RuntimeDomain)
    reset_resource!(AshUIExamples.Icon.UiBinding, AshUIExamples.Icon.UiStorageDomain)
    reset_resource!(AshUIExamples.Icon.UiElement, AshUIExamples.Icon.UiStorageDomain)
    reset_resource!(AshUIExamples.Icon.UiScreen, AshUIExamples.Icon.UiStorageDomain)
    :ok
  end
  ...
  def seed!(opts \\ []) do
    ...
    {:ok, _state} =
      Ash.create(
        AshUIExamples.Icon.Runtime.ExampleState,
        seed_state(),
        domain: AshUIExamples.Icon.RuntimeDomain,
        authorize?: false
      )

    {:ok, screen} =
      Authority.create(
        AshUIExamples.Icon.Examples.IconScreen,
        actor: actor,
        name: @screen_name,
  ...
  defmodule Application do
    ...
    def start(_type, _args) do
      children = [
        {Phoenix.PubSub, name: AshUIExamples.Icon.PubSub},
        AshUIExamples.Icon.Web.Endpoint
      ]
  ...
  defmodule RuntimeDomain do
    ...
    resources do
      resource(AshUIExamples.Icon.Runtime.ExampleState)
    end
  end

  defmodule Runtime.ExampleState do
    use Ash.Resource, domain: AshUIExamples.Icon.RuntimeDomain, data_layer: Ash.DataLayer.Ets
  ...
  defmodule UiStorageDomain do
    ...
    resources do
      resource(AshUIExamples.Icon.UiScreen)
      resource(AshUIExamples.Icon.UiElement)
      resource(AshUIExamples.Icon.UiBinding)
    end
  end
  ...
  defmodule UiScreen do
    ...
    relationships do
      has_many :elements, AshUIExamples.Icon.UiElement do
        destination_attribute(:screen_id)
      end

      has_many :bindings, AshUIExamples.Icon.UiBinding do
        destination_attribute(:screen_id)
      end
    end
  ...
  defmodule UiElement do
    ...
    relationships do
      belongs_to :screen, AshUIExamples.Icon.UiScreen do
        attribute_type(:uuid)
        allow_nil?(true)
      end
  ...
  defmodule UiBinding do
    ...
    relationships do
      belongs_to :element, AshUIExamples.Icon.UiElement do
        attribute_type(:uuid)
        allow_nil?(true)
      end
  ...
  defmodule AuthoringDomain do
    ...
    resources do
      resource(AshUIExamples.Icon.Examples.IconScreen)
      resource(AshUIExamples.Icon.Examples.IconDemoPanelElement)
      resource(AshUIExamples.Icon.Examples.IconSubjectElement)
      resource(AshUIExamples.Icon.Examples.IconPreviewElement)
      resource(AshUIExamples.Icon.Examples.IconStoryTextElement)
      resource(AshUIExamples.Icon.Examples.IconSignalTextElement)
    end
  end
  ...
  defmodule ExampleElementBase do
    defmacro __using__(_opts) do
      quote do
        use Ash.Resource,
          domain: AshUIExamples.Icon.AuthoringDomain,
          data_layer: Ash.DataLayer.Ets
  ...
  defmodule Examples.IconDemoPanelElement do
    use AshUIExamples.Icon.ExampleElementBase

    relationships do
      has_many :subjects, AshUIExamples.Icon.Examples.IconSubjectElement do
        destination_attribute(:parent_id)
      end

      has_many :previews, AshUIExamples.Icon.Examples.IconPreviewElement do
        destination_attribute(:parent_id)
      end
    end
    ...
    ui_element do
      type(:card)
      props(%{title: "Icon Example", class: "ashui-example-panel"})
      metadata(%{id: "example-icon-demo", section: "demo", slot: "body", position: 0})
    end
  end

  defmodule Examples.IconSubjectElement do
    use AshUIExamples.Icon.ExampleElementBase

    ui_element do
      type(:icon)
      props(%{label: "Ready", name: "sparkles", class: "ashui-example-icon"})
      metadata(%{id: "example-icon-subject", section: "demo", slot: "body", position: 1})
    end

    ui_bindings do
      binding :icon_label do
        source(%{resource: "ExampleState", field: :display_value, id: "state-icon"})
        target("label")
        binding_type(:value)
        transform(%{})
  ...
  defmodule Examples.IconPreviewElement do
    use AshUIExamples.Icon.ExampleElementBase
    ...
    ui_element do
      ...
      props(%{
        title: "Renderer note",
        value: "Icon fallback renderer admitted for standalone examples."
      })

      variants([:primary])
      metadata(%{id: "example-icon-preview", section: "demo", slot: "body", position: 2})
    end

    ui_bindings do
      binding :preview_value do
        source(%{resource: "ExampleState", field: :status, id: "state-icon"})
        target("value")
        binding_type(:value)
        transform(%{})
  ...
  defmodule Examples.IconStoryTextElement do
    use AshUIExamples.Icon.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{id: "example-icon-story", section: "story", slot: "body", position: 10})
    end
  end

  defmodule Examples.IconSignalTextElement do
    use AshUIExamples.Icon.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{
        id: "example-icon-signal-preview",
  ...
  defmodule Examples.IconScreen do
    use Ash.Resource,
      domain: AshUIExamples.Icon.AuthoringDomain,
      data_layer: Ash.DataLayer.Ets
    ...
    relationships do
      has_many :demo_panels, AshUIExamples.Icon.Examples.IconDemoPanelElement do
        destination_attribute(:screen_id)
      end

      has_many :story_texts, AshUIExamples.Icon.Examples.IconStoryTextElement do
        destination_attribute(:screen_id)
      end

      has_many :signal_texts, AshUIExamples.Icon.Examples.IconSignalTextElement do
        destination_attribute(:screen_id)
      end
    end
    ...
    ui_screen do
      ...
      metadata(%{
        title: "Icon Example",
        example_directory: "icon",
        shell_id: "example-icon-shell"
      })
    end
  end

  defmodule ExampleSeeds do
    def seed!(opts \\ []), do: AshUIExamples.Icon.seed!(opts)
    def reset!, do: AshUIExamples.Icon.reset!()
  end
  ...
  defmodule Web.Router do
    ...
    scope "/", AshUIExamples.Icon.Web do
  ...
  defmodule Web.Endpoint do
    use Phoenix.Endpoint, otp_app: :ash_ui_example_icon
    ...
    plug(AshUIExamples.Icon.Web.Router)
  end
  ...
  defmodule Web.ExampleLive do
    ...
    alias AshUIExamples.Icon.Web.Components.ExampleShell
    alias AshUI.LiveView.EventHandler
    alias AshUI.LiveView.Integration

    def mount(params, _session, socket) do
      _ = AshUIExamples.Icon.seed!()
      example_runtime = runtime_from_params(params)

      socket =
        socket
        |> Phoenix.Component.assign(:current_user, AshUIExamples.Icon.current_user())
        |> Phoenix.Component.assign(:ash_ui_storage, AshUIExamples.Icon.ui_storage())
        |> Phoenix.Component.assign(:ash_ui_domains, AshUIExamples.Icon.runtime_domains())
        |> Phoenix.Component.assign(:page_title, "Icon Example")
        |> Phoenix.Component.assign(:example_directory, "icon")
        |> Phoenix.Component.assign(:theme_css, AshUIExamples.Icon.theme_css())
        |> Phoenix.Component.assign(:example_runtime, example_runtime)
        |> Phoenix.Component.assign(:supported_runtimes, AshUIExamples.Icon.supported_runtimes())

      with {:ok, socket} <- Integration.mount_ui_screen(socket, "example/icon", params),
    ...
    def render(assigns) do
      assigns =
        ...
        |> Phoenix.Component.assign_new(:supported_runtimes, fn ->
          AshUIExamples.Icon.supported_runtimes()
        end)
        |> Phoenix.Component.assign_new(:example_runtime, fn ->
          AshUIExamples.Icon.default_runtime()
        end)
        |> Phoenix.Component.assign_new(:rendered_runtime, fn ->
          %{
            content: assigns[:rendered_ui] || "",
            description:
              AshUIExamples.Icon.runtime_description(AshUIExamples.Icon.default_runtime()),
            mode: :live_fragment,
            runtime: AshUIExamples.Icon.default_runtime()
          }
        end)
      ...
      <ExampleShell.example_shell
        ...
        summary={"Meaningful Interaction Story: review the icon inside the shared presentation panel and confirm the fallback renderer exposes both the glyph token and its accessible label."}
        theme_css={@theme_css}
      >
    ...
    defp refresh_rendered_ui(socket) do
      rendered_runtime =
        AshUIExamples.Icon.rendered_runtime(
          socket.assigns,
          socket.assigns[:example_runtime] || AshUIExamples.Icon.default_runtime()
        )
    ...
    defp runtime_from_params(params) do
      params["runtime"]
      |> fallback_runtime()
      |> AshUIExamples.Icon.normalize_runtime!()
    end
