defmodule AshUIExamples.Image do
  @moduledoc """
  Standalone resource-authority Ash UI app for the `image` example.
  """
  ...
  def app, do: :ash_ui_example_image
  ...
  def runtime_domains, do: [AshUIExamples.Image.RuntimeDomain]

  def current_user,
    do: %{active: true, id: "reviewer-image", name: "Example Reviewer", role: :admin}
  ...
  def reset! do
    reset_resource!(AshUIExamples.Image.Runtime.ExampleState, AshUIExamples.Image.RuntimeDomain)
    reset_resource!(AshUIExamples.Image.UiBinding, AshUIExamples.Image.UiStorageDomain)
    reset_resource!(AshUIExamples.Image.UiElement, AshUIExamples.Image.UiStorageDomain)
    reset_resource!(AshUIExamples.Image.UiScreen, AshUIExamples.Image.UiStorageDomain)
    :ok
  end
  ...
  def seed!(opts \\ []) do
    ...
    {:ok, _state} =
      Ash.create(
        AshUIExamples.Image.Runtime.ExampleState,
        seed_state(),
        domain: AshUIExamples.Image.RuntimeDomain,
        authorize?: false
      )

    {:ok, screen} =
      Authority.create(
        AshUIExamples.Image.Examples.ImageScreen,
        actor: actor,
        name: @screen_name,
  ...
  defmodule Application do
    ...
    def start(_type, _args) do
      children = [
        {Phoenix.PubSub, name: AshUIExamples.Image.PubSub},
        AshUIExamples.Image.Web.Endpoint
      ]
  ...
  defmodule RuntimeDomain do
    ...
    resources do
      resource(AshUIExamples.Image.Runtime.ExampleState)
    end
  end

  defmodule Runtime.ExampleState do
    use Ash.Resource, domain: AshUIExamples.Image.RuntimeDomain, data_layer: Ash.DataLayer.Ets
  ...
  defmodule UiStorageDomain do
    ...
    resources do
      resource(AshUIExamples.Image.UiScreen)
      resource(AshUIExamples.Image.UiElement)
      resource(AshUIExamples.Image.UiBinding)
    end
  end
  ...
  defmodule UiScreen do
    ...
    relationships do
      has_many :elements, AshUIExamples.Image.UiElement do
        destination_attribute(:screen_id)
      end

      has_many :bindings, AshUIExamples.Image.UiBinding do
        destination_attribute(:screen_id)
      end
    end
  ...
  defmodule UiElement do
    ...
    relationships do
      belongs_to :screen, AshUIExamples.Image.UiScreen do
        attribute_type(:uuid)
        allow_nil?(true)
      end
  ...
  defmodule UiBinding do
    ...
    relationships do
      belongs_to :element, AshUIExamples.Image.UiElement do
        attribute_type(:uuid)
        allow_nil?(true)
      end
  ...
  defmodule AuthoringDomain do
    ...
    resources do
      resource(AshUIExamples.Image.Examples.ImageScreen)
      resource(AshUIExamples.Image.Examples.ImageDemoPanelElement)
      resource(AshUIExamples.Image.Examples.ImageSubjectElement)
      resource(AshUIExamples.Image.Examples.ImagePreviewElement)
      resource(AshUIExamples.Image.Examples.ImageStoryTextElement)
      resource(AshUIExamples.Image.Examples.ImageSignalTextElement)
    end
  end
  ...
  defmodule ExampleElementBase do
    defmacro __using__(_opts) do
      quote do
        use Ash.Resource,
          domain: AshUIExamples.Image.AuthoringDomain,
          data_layer: Ash.DataLayer.Ets
  ...
  defmodule Examples.ImageDemoPanelElement do
    use AshUIExamples.Image.ExampleElementBase

    relationships do
      has_many :subjects, AshUIExamples.Image.Examples.ImageSubjectElement do
        destination_attribute(:parent_id)
      end

      has_many :previews, AshUIExamples.Image.Examples.ImagePreviewElement do
        destination_attribute(:parent_id)
      end
    end
    ...
    ui_element do
      type(:card)
      props(%{title: "Image Example", class: "ashui-example-panel"})
      metadata(%{id: "example-image-demo", section: "demo", slot: "body", position: 0})
    end
  end

  defmodule Examples.ImageSubjectElement do
    use AshUIExamples.Image.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{id: "example-image-subject", section: "demo", slot: "body", position: 1})
    end
  end

  defmodule Examples.ImagePreviewElement do
    use AshUIExamples.Image.ExampleElementBase
    ...
    ui_element do
      ...
      props(%{
        title: "Renderer note",
        value: "Image preview uses the fallback renderer's image-specific markup."
      })

      variants([:primary])
      metadata(%{id: "example-image-preview", section: "demo", slot: "body", position: 2})
    end

    ui_bindings do
      binding :preview_value do
        source(%{resource: "ExampleState", field: :status, id: "state-image"})
        target("value")
        binding_type(:value)
        transform(%{})
  ...
  defmodule Examples.ImageStoryTextElement do
    use AshUIExamples.Image.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{id: "example-image-story", section: "story", slot: "body", position: 10})
    end
  end

  defmodule Examples.ImageSignalTextElement do
    use AshUIExamples.Image.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{
        id: "example-image-signal-preview",
  ...
  defmodule Examples.ImageScreen do
    use Ash.Resource,
      domain: AshUIExamples.Image.AuthoringDomain,
      data_layer: Ash.DataLayer.Ets
    ...
    relationships do
      has_many :demo_panels, AshUIExamples.Image.Examples.ImageDemoPanelElement do
        destination_attribute(:screen_id)
      end

      has_many :story_texts, AshUIExamples.Image.Examples.ImageStoryTextElement do
        destination_attribute(:screen_id)
      end

      has_many :signal_texts, AshUIExamples.Image.Examples.ImageSignalTextElement do
        destination_attribute(:screen_id)
      end
    end
    ...
    ui_screen do
      ...
      metadata(%{
        title: "Image Example",
        example_directory: "image",
        shell_id: "example-image-shell"
      })
    end
  end

  defmodule ExampleSeeds do
    def seed!(opts \\ []), do: AshUIExamples.Image.seed!(opts)
    def reset!, do: AshUIExamples.Image.reset!()
  end
  ...
  defmodule Web.Router do
    ...
    scope "/", AshUIExamples.Image.Web do
  ...
  defmodule Web.Endpoint do
    use Phoenix.Endpoint, otp_app: :ash_ui_example_image
    ...
    plug(AshUIExamples.Image.Web.Router)
  end
  ...
  defmodule Web.ExampleLive do
    ...
    alias AshUIExamples.Image.Web.Components.ExampleShell
    alias AshUI.LiveView.EventHandler
    alias AshUI.LiveView.Integration

    def mount(params, _session, socket) do
      _ = AshUIExamples.Image.seed!()
      example_runtime = runtime_from_params(params)

      socket =
        socket
        |> Phoenix.Component.assign(:current_user, AshUIExamples.Image.current_user())
        |> Phoenix.Component.assign(:ash_ui_storage, AshUIExamples.Image.ui_storage())
        |> Phoenix.Component.assign(:ash_ui_domains, AshUIExamples.Image.runtime_domains())
        |> Phoenix.Component.assign(:page_title, "Image Example")
        |> Phoenix.Component.assign(:example_directory, "image")
        |> Phoenix.Component.assign(:theme_css, AshUIExamples.Image.theme_css())
        |> Phoenix.Component.assign(:example_runtime, example_runtime)
        |> Phoenix.Component.assign(:supported_runtimes, AshUIExamples.Image.supported_runtimes())

      with {:ok, socket} <- Integration.mount_ui_screen(socket, "example/image", params),
    ...
    def render(assigns) do
      assigns =
        ...
        |> Phoenix.Component.assign_new(:supported_runtimes, fn ->
          AshUIExamples.Image.supported_runtimes()
        end)
        |> Phoenix.Component.assign_new(:example_runtime, fn ->
          AshUIExamples.Image.default_runtime()
        end)
        |> Phoenix.Component.assign_new(:rendered_runtime, fn ->
          %{
            content: assigns[:rendered_ui] || "",
            description:
              AshUIExamples.Image.runtime_description(AshUIExamples.Image.default_runtime()),
            mode: :live_fragment,
            runtime: AshUIExamples.Image.default_runtime()
          }
        end)
      ...
      <ExampleShell.example_shell
        ...
        summary={"Meaningful Interaction Story: confirm the image example renders as a real preview surface rather than a generic wrapper while still using the shared Ash HQ shell."}
        theme_css={@theme_css}
      >
    ...
    defp refresh_rendered_ui(socket) do
      rendered_runtime =
        AshUIExamples.Image.rendered_runtime(
          socket.assigns,
          socket.assigns[:example_runtime] || AshUIExamples.Image.default_runtime()
        )
    ...
    defp runtime_from_params(params) do
      params["runtime"]
      |> fallback_runtime()
      |> AshUIExamples.Image.normalize_runtime!()
    end
