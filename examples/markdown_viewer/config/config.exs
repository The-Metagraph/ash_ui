...
config :ash_ui_example_markdown_viewer,
  ecto_repos: []

config :ash_ui_example_markdown_viewer, AshUIExamples.MarkdownViewer.Web.Endpoint,
  url: [host: "127.0.0.1"],
...
config :ash_ui, :ash_domains, [AshUIExamples.MarkdownViewer.RuntimeDomain]
