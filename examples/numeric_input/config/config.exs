...
config :ash_ui_example_numeric_input,
  ecto_repos: []

config :ash_ui_example_numeric_input, AshUIExamples.NumericInput.Web.Endpoint,
  url: [host: "127.0.0.1"],
...
config :ash_ui, :ash_domains, [AshUIExamples.NumericInput.RuntimeDomain]
