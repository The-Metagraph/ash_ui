...
config :ash_ui_example_overlay,
  ecto_repos: []

config :ash_ui_example_overlay, AshUIExamples.Overlay.Web.Endpoint,
  url: [host: "127.0.0.1"],
...
config :ash_ui, :ash_domains, [AshUIExamples.Overlay.RuntimeDomain]
