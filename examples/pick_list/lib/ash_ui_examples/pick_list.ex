defmodule AshUIExamples.PickList do
  @moduledoc """
  Standalone resource-authority Ash UI app for the `pick_list` example.
  """
  ...
  def app, do: :ash_ui_example_pick_list
  ...
  def runtime_domains, do: [AshUIExamples.PickList.RuntimeDomain]

  def current_user,
    do: %{
      active: true,
      id: "reviewer-pick_list",
  ...
  def reset! do
    reset_resource!(
      AshUIExamples.PickList.Runtime.ExampleState,
      AshUIExamples.PickList.RuntimeDomain
    )

    reset_resource!(AshUIExamples.PickList.UiBinding, AshUIExamples.PickList.UiStorageDomain)
    reset_resource!(AshUIExamples.PickList.UiElement, AshUIExamples.PickList.UiStorageDomain)
    reset_resource!(AshUIExamples.PickList.UiScreen, AshUIExamples.PickList.UiStorageDomain)
    :ok
  end
  ...
  def seed!(opts \\ []) do
    ...
    {:ok, _state} =
      Ash.create(
        AshUIExamples.PickList.Runtime.ExampleState,
        seed_state(),
        domain: AshUIExamples.PickList.RuntimeDomain,
        authorize?: false
      )

    {:ok, screen} =
      Authority.create(
        AshUIExamples.PickList.Examples.PickListScreen,
        actor: actor,
        name: @screen_name,
  ...
  defmodule Application do
    ...
    def start(_type, _args) do
      children = [
        {Phoenix.PubSub, name: AshUIExamples.PickList.PubSub},
        AshUIExamples.PickList.Web.Endpoint
      ]
  ...
  defmodule RuntimeDomain do
    ...
    resources do
      resource(AshUIExamples.PickList.Runtime.ExampleState)
    end
  end

  defmodule Runtime.ExampleState do
    use Ash.Resource, domain: AshUIExamples.PickList.RuntimeDomain, data_layer: Ash.DataLayer.Ets
  ...
  defmodule UiStorageDomain do
    ...
    resources do
      resource(AshUIExamples.PickList.UiScreen)
      resource(AshUIExamples.PickList.UiElement)
      resource(AshUIExamples.PickList.UiBinding)
    end
  end
  ...
  defmodule UiScreen do
    ...
    relationships do
      has_many :elements, AshUIExamples.PickList.UiElement do
        destination_attribute(:screen_id)
      end

      has_many :bindings, AshUIExamples.PickList.UiBinding do
        destination_attribute(:screen_id)
      end
    end
  ...
  defmodule UiElement do
    ...
    relationships do
      belongs_to :screen, AshUIExamples.PickList.UiScreen do
        attribute_type(:uuid)
        allow_nil?(true)
      end
  ...
  defmodule UiBinding do
    ...
    relationships do
      belongs_to :element, AshUIExamples.PickList.UiElement do
        attribute_type(:uuid)
        allow_nil?(true)
      end
  ...
  defmodule AuthoringDomain do
    ...
    resources do
      resource(AshUIExamples.PickList.Examples.PickListScreen)
      resource(AshUIExamples.PickList.Examples.PickListDemoPanelElement)
      resource(AshUIExamples.PickList.Examples.PickListSubjectElement)
      resource(AshUIExamples.PickList.Examples.PickListPreviewElement)
      resource(AshUIExamples.PickList.Examples.PickListStoryTextElement)
      resource(AshUIExamples.PickList.Examples.PickListSignalTextElement)
      resource(AshUIExamples.PickList.Examples.PickListSupportNoticeElement)
    end
  end
  ...
  defmodule ExampleElementBase do
    defmacro __using__(_opts) do
      quote do
        use Ash.Resource,
          domain: AshUIExamples.PickList.AuthoringDomain,
          data_layer: Ash.DataLayer.Ets
  ...
  defmodule Examples.PickListDemoPanelElement do
    use AshUIExamples.PickList.ExampleElementBase

    relationships do
      has_many :subjects, AshUIExamples.PickList.Examples.PickListSubjectElement do
        destination_attribute(:parent_id)
      end

      has_many :previews, AshUIExamples.PickList.Examples.PickListPreviewElement do
        destination_attribute(:parent_id)
      end

      has_many :support_notices, AshUIExamples.PickList.Examples.PickListSupportNoticeElement do
        destination_attribute(:parent_id)
      end
    end
    ...
    ui_element do
      type(:card)
      props(%{title: "Pick List Example", class: "ashui-example-panel"})
      metadata(%{id: "example-pick_list-demo", section: "demo", slot: "body", position: 0})
    end
  end

  defmodule Examples.PickListSubjectElement do
    use AshUIExamples.PickList.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{id: "example-pick_list-subject", section: "demo", slot: "body", position: 1})
    end

    ui_bindings do
      binding :pick_list_value do
        source(%{resource: "ExampleState", field: :selected_value, id: "state-pick_list"})
        target("value")
        binding_type(:value)
        transform(%{})
  ...
  defmodule Examples.PickListPreviewElement do
    use AshUIExamples.PickList.ExampleElementBase

    ui_element do
      type(:stat)
      props(%{title: "Promoted pick", value: "ops"})
      variants([:primary])
      metadata(%{id: "example-pick_list-preview", section: "demo", slot: "body", position: 2})
    end
  ...
  defmodule Examples.PickListStoryTextElement do
    use AshUIExamples.PickList.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{id: "example-pick_list-story", section: "story", slot: "body", position: 10})
    end
  end

  defmodule Examples.PickListSignalTextElement do
    use AshUIExamples.PickList.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{
        id: "example-pick_list-signal-preview",
  ...
  defmodule Examples.PickListSupportNoticeElement do
    use AshUIExamples.PickList.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{
        id: "example-pick_list-support-note",
        section: "demo",
        slot: "body",
        position: 3
      })
  ...
  defmodule Examples.PickListScreen do
    use Ash.Resource,
      domain: AshUIExamples.PickList.AuthoringDomain,
      data_layer: Ash.DataLayer.Ets
    ...
    relationships do
      has_many :demo_panels, AshUIExamples.PickList.Examples.PickListDemoPanelElement do
        destination_attribute(:screen_id)
      end

      has_many :story_texts, AshUIExamples.PickList.Examples.PickListStoryTextElement do
        destination_attribute(:screen_id)
      end

      has_many :signal_texts, AshUIExamples.PickList.Examples.PickListSignalTextElement do
        destination_attribute(:screen_id)
      end
    end
    ...
    ui_screen do
      ...
      metadata(%{
        title: "Pick List Example",
        example_directory: "pick_list",
        shell_id: "example-pick_list-shell"
      })
    end
  end

  defmodule ExampleSeeds do
    def seed!(opts \\ []), do: AshUIExamples.PickList.seed!(opts)
    def reset!, do: AshUIExamples.PickList.reset!()
  end
  ...
  defmodule Web.Router do
    ...
    scope "/", AshUIExamples.PickList.Web do
  ...
  defmodule Web.Endpoint do
    use Phoenix.Endpoint, otp_app: :ash_ui_example_pick_list
    ...
    plug(AshUIExamples.PickList.Web.Router)
  end
  ...
  defmodule Web.ExampleLive do
    ...
    alias AshUIExamples.PickList.Web.Components.ExampleShell
    alias AshUI.LiveView.EventHandler
    alias AshUI.LiveView.Integration

    def mount(params, _session, socket) do
      _ = AshUIExamples.PickList.seed!()
      example_runtime = runtime_from_params(params)

      socket =
        socket
        |> Phoenix.Component.assign(:current_user, AshUIExamples.PickList.current_user())
        |> Phoenix.Component.assign(:ash_ui_storage, AshUIExamples.PickList.ui_storage())
        |> Phoenix.Component.assign(:ash_ui_domains, AshUIExamples.PickList.runtime_domains())
        |> Phoenix.Component.assign(:page_title, "Pick List Example")
        |> Phoenix.Component.assign(:example_directory, "pick_list")
        |> Phoenix.Component.assign(:theme_css, AshUIExamples.PickList.theme_css())
        |> Phoenix.Component.assign(:example_runtime, example_runtime)
        |> Phoenix.Component.assign(
          :supported_runtimes,
          AshUIExamples.PickList.supported_runtimes()
        )

      with {:ok, socket} <- Integration.mount_ui_screen(socket, "example/pick_list", params),
    ...
    def render(assigns) do
      assigns =
        ...
        |> Phoenix.Component.assign_new(:example_runtime, fn ->
          AshUIExamples.PickList.default_runtime()
        end)
        |> Phoenix.Component.assign_new(:rendered_runtime, fn ->
          %{
            content: assigns[:rendered_ui] || "",
            description:
              AshUIExamples.PickList.runtime_description(AshUIExamples.PickList.default_runtime()),
            mode: :live_fragment,
            runtime: AshUIExamples.PickList.default_runtime()
          }
        end)
      ...
      <ExampleShell.example_shell
        ...
        summary={"Meaningful Interaction Story: choose one promoted pick-list option and confirm the custom surface stays explicit about the current single-selection runtime boundary."}
        theme_css={@theme_css}
      >
    ...
    defp refresh_rendered_ui(socket) do
      rendered_runtime =
        AshUIExamples.PickList.rendered_runtime(
          socket.assigns,
          socket.assigns[:example_runtime] || AshUIExamples.PickList.default_runtime()
        )
    ...
    defp runtime_from_params(params) do
      params["runtime"]
      |> fallback_runtime()
      |> AshUIExamples.PickList.normalize_runtime!()
    end
