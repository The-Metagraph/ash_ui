defmodule AshUIExamples.Separator do
  @moduledoc """
  Standalone resource-authority Ash UI app for the `separator` example.
  """
  ...
  @definition %{
    ...
    subject_props: %{class: "ashui-example-divider"}
  }
  ...
  def app, do: :ash_ui_example_separator
  ...
  def ui_storage do
    [
      domain: AshUIExamples.Separator.UiStorageDomain,
      resources: [
        screen: AshUIExamples.Separator.UiScreen,
        element: AshUIExamples.Separator.UiElement,
        binding: AshUIExamples.Separator.UiBinding
      ],
      repo: nil
    ]
  end

  def runtime_domains, do: [AshUIExamples.Separator.RuntimeDomain]

  def current_user,
    do: %{
      active: true,
      id: "reviewer-separator",
  ...
  def reset! do
    reset_resource!(
      AshUIExamples.Separator.Runtime.ExampleState,
      AshUIExamples.Separator.RuntimeDomain
    )

    reset_resource!(AshUIExamples.Separator.UiBinding, AshUIExamples.Separator.UiStorageDomain)
    reset_resource!(AshUIExamples.Separator.UiElement, AshUIExamples.Separator.UiStorageDomain)
    reset_resource!(AshUIExamples.Separator.UiScreen, AshUIExamples.Separator.UiStorageDomain)
    :ok
  end
  ...
  def seed!(opts \\ []) do
    ...
    {:ok, _state} =
      Ash.create(
        AshUIExamples.Separator.Runtime.ExampleState,
        seed_state(),
        domain: AshUIExamples.Separator.RuntimeDomain,
        authorize?: false
      )

    {:ok, screen} =
      Authority.create(
        AshUIExamples.Separator.Examples.SeparatorScreen,
        actor: actor,
        name: @screen_name,
  ...
  defmodule Application do
    ...
    def start(_type, _args) do
      children = [
        {Phoenix.PubSub, name: AshUIExamples.Separator.PubSub},
        AshUIExamples.Separator.Web.Endpoint
      ]
  ...
  defmodule RuntimeDomain do
    ...
    resources do
      resource(AshUIExamples.Separator.Runtime.ExampleState)
    end
  end

  defmodule Runtime.ExampleState do
    use Ash.Resource, domain: AshUIExamples.Separator.RuntimeDomain, data_layer: Ash.DataLayer.Ets
  ...
  defmodule UiStorageDomain do
    ...
    resources do
      resource(AshUIExamples.Separator.UiScreen)
      resource(AshUIExamples.Separator.UiElement)
      resource(AshUIExamples.Separator.UiBinding)
    end
  end
  ...
  defmodule UiScreen do
    ...
    relationships do
      has_many :elements, AshUIExamples.Separator.UiElement do
        destination_attribute(:screen_id)
      end

      has_many :bindings, AshUIExamples.Separator.UiBinding do
        destination_attribute(:screen_id)
      end
    end
  ...
  defmodule UiElement do
    ...
    relationships do
      belongs_to :screen, AshUIExamples.Separator.UiScreen do
        attribute_type(:uuid)
        allow_nil?(true)
      end
  ...
  defmodule UiBinding do
    ...
    relationships do
      belongs_to :element, AshUIExamples.Separator.UiElement do
        attribute_type(:uuid)
        allow_nil?(true)
      end
  ...
  defmodule AuthoringDomain do
    ...
    resources do
      resource(AshUIExamples.Separator.Examples.SeparatorScreen)
      resource(AshUIExamples.Separator.Examples.SeparatorDemoPanelElement)
      resource(AshUIExamples.Separator.Examples.SeparatorSubjectElement)
      resource(AshUIExamples.Separator.Examples.SeparatorPreviewElement)
      resource(AshUIExamples.Separator.Examples.SeparatorStoryTextElement)
      resource(AshUIExamples.Separator.Examples.SeparatorSignalTextElement)
    end
  end
  ...
  defmodule ExampleElementBase do
    defmacro __using__(_opts) do
      quote do
        use Ash.Resource,
          domain: AshUIExamples.Separator.AuthoringDomain,
          data_layer: Ash.DataLayer.Ets
  ...
  defmodule Examples.SeparatorDemoPanelElement do
    use AshUIExamples.Separator.ExampleElementBase

    relationships do
      has_many :subjects, AshUIExamples.Separator.Examples.SeparatorSubjectElement do
        destination_attribute(:parent_id)
      end

      has_many :previews, AshUIExamples.Separator.Examples.SeparatorPreviewElement do
        destination_attribute(:parent_id)
      end
    end
    ...
    ui_element do
      type(:card)
      props(%{title: "Separator Example", class: "ashui-example-panel"})
      metadata(%{id: "example-separator-demo", section: "demo", slot: "body", position: 0})
    end
  end

  defmodule Examples.SeparatorSubjectElement do
    use AshUIExamples.Separator.ExampleElementBase

    ui_element do
      type(:divider)
      props(%{class: "ashui-example-divider"})
      metadata(%{id: "example-separator-subject", section: "demo", slot: "body", position: 1})
    end
  end

  defmodule Examples.SeparatorPreviewElement do
    use AshUIExamples.Separator.ExampleElementBase
    ...
    ui_element do
      ...
      props(%{
        title: "Normalization",
        value: "Directory parity preserved through canonical divider authoring."
      })

      variants([:primary])
      metadata(%{id: "example-separator-preview", section: "demo", slot: "body", position: 2})
    end

    ui_bindings do
      binding :preview_value do
        source(%{resource: "ExampleState", field: :status, id: "state-separator"})
        target("value")
        binding_type(:value)
        transform(%{})
  ...
  defmodule Examples.SeparatorStoryTextElement do
    use AshUIExamples.Separator.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{id: "example-separator-story", section: "story", slot: "body", position: 10})
    end
  end

  defmodule Examples.SeparatorSignalTextElement do
    use AshUIExamples.Separator.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{
        id: "example-separator-signal-preview",
  ...
  defmodule Examples.SeparatorScreen do
    use Ash.Resource,
      domain: AshUIExamples.Separator.AuthoringDomain,
      data_layer: Ash.DataLayer.Ets
    ...
    relationships do
      has_many :demo_panels, AshUIExamples.Separator.Examples.SeparatorDemoPanelElement do
        destination_attribute(:screen_id)
      end

      has_many :story_texts, AshUIExamples.Separator.Examples.SeparatorStoryTextElement do
        destination_attribute(:screen_id)
      end

      has_many :signal_texts, AshUIExamples.Separator.Examples.SeparatorSignalTextElement do
        destination_attribute(:screen_id)
      end
    end
    ...
    ui_screen do
      ...
      metadata(%{
        title: "Separator Example",
        example_directory: "separator",
        shell_id: "example-separator-shell"
      })
    end
  end

  defmodule ExampleSeeds do
    def seed!(opts \\ []), do: AshUIExamples.Separator.seed!(opts)
    def reset!, do: AshUIExamples.Separator.reset!()
  end
  ...
  defmodule Web.Router do
    ...
    scope "/", AshUIExamples.Separator.Web do
  ...
  defmodule Web.Endpoint do
    use Phoenix.Endpoint, otp_app: :ash_ui_example_separator
    ...
    plug(AshUIExamples.Separator.Web.Router)
  end
  ...
  defmodule Web.ExampleLive do
    ...
    alias AshUIExamples.Separator.Web.Components.ExampleShell
    alias AshUI.LiveView.EventHandler
    alias AshUI.LiveView.Integration

    def mount(params, _session, socket) do
      _ = AshUIExamples.Separator.seed!()
      example_runtime = runtime_from_params(params)

      socket =
        socket
        |> Phoenix.Component.assign(:current_user, AshUIExamples.Separator.current_user())
        |> Phoenix.Component.assign(:ash_ui_storage, AshUIExamples.Separator.ui_storage())
        |> Phoenix.Component.assign(:ash_ui_domains, AshUIExamples.Separator.runtime_domains())
        |> Phoenix.Component.assign(:page_title, "Separator Example")
        |> Phoenix.Component.assign(:example_directory, "separator")
        |> Phoenix.Component.assign(:theme_css, AshUIExamples.Separator.theme_css())
        |> Phoenix.Component.assign(:example_runtime, example_runtime)
        |> Phoenix.Component.assign(
          :supported_runtimes,
          AshUIExamples.Separator.supported_runtimes()
        )

      with {:ok, socket} <- Integration.mount_ui_screen(socket, "example/separator", params),
    ...
    def render(assigns) do
      assigns =
        ...
        |> Phoenix.Component.assign_new(:example_runtime, fn ->
          AshUIExamples.Separator.default_runtime()
        end)
        |> Phoenix.Component.assign_new(:rendered_runtime, fn ->
          %{
            content: assigns[:rendered_ui] || "",
            description:
              AshUIExamples.Separator.runtime_description(
                AshUIExamples.Separator.default_runtime()
              ),
            mode: :live_fragment,
            runtime: AshUIExamples.Separator.default_runtime()
          }
        end)
      ...
      <ExampleShell.example_shell
        ...
        summary={"Meaningful Interaction Story: review how the normalized `divider` subject preserves the sibling directory name while keeping the shell visually structured."}
        theme_css={@theme_css}
      >
    ...
    defp refresh_rendered_ui(socket) do
      rendered_runtime =
        AshUIExamples.Separator.rendered_runtime(
          socket.assigns,
          socket.assigns[:example_runtime] || AshUIExamples.Separator.default_runtime()
        )
    ...
    defp runtime_from_params(params) do
      params["runtime"]
      |> fallback_runtime()
      |> AshUIExamples.Separator.normalize_runtime!()
    end
