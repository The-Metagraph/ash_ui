defmodule AshUIExamples.Spacer do
  @moduledoc """
  Standalone resource-authority Ash UI app for the `spacer` example.
  """
  ...
  @definition %{
    ...
    subject_props: %{size: 32, class: "ashui-example-spacer"}
  }
  ...
  def app, do: :ash_ui_example_spacer
  ...
  def runtime_domains, do: [AshUIExamples.Spacer.RuntimeDomain]

  def current_user,
    do: %{active: true, id: "reviewer-spacer", name: "Example Reviewer", role: :admin}
  ...
  def reset! do
    reset_resource!(AshUIExamples.Spacer.Runtime.ExampleState, AshUIExamples.Spacer.RuntimeDomain)
    reset_resource!(AshUIExamples.Spacer.UiBinding, AshUIExamples.Spacer.UiStorageDomain)
    reset_resource!(AshUIExamples.Spacer.UiElement, AshUIExamples.Spacer.UiStorageDomain)
    reset_resource!(AshUIExamples.Spacer.UiScreen, AshUIExamples.Spacer.UiStorageDomain)
    :ok
  end
  ...
  def seed!(opts \\ []) do
    ...
    {:ok, _state} =
      Ash.create(
        AshUIExamples.Spacer.Runtime.ExampleState,
        seed_state(),
        domain: AshUIExamples.Spacer.RuntimeDomain,
        authorize?: false
      )

    {:ok, screen} =
      Authority.create(
        AshUIExamples.Spacer.Examples.SpacerScreen,
        actor: actor,
        name: @screen_name,
  ...
  defmodule Application do
    ...
    def start(_type, _args) do
      children = [
        {Phoenix.PubSub, name: AshUIExamples.Spacer.PubSub},
        AshUIExamples.Spacer.Web.Endpoint
      ]
  ...
  defmodule RuntimeDomain do
    ...
    resources do
      resource(AshUIExamples.Spacer.Runtime.ExampleState)
    end
  end

  defmodule Runtime.ExampleState do
    use Ash.Resource, domain: AshUIExamples.Spacer.RuntimeDomain, data_layer: Ash.DataLayer.Ets
  ...
  defmodule UiStorageDomain do
    ...
    resources do
      resource(AshUIExamples.Spacer.UiScreen)
      resource(AshUIExamples.Spacer.UiElement)
      resource(AshUIExamples.Spacer.UiBinding)
    end
  end
  ...
  defmodule UiScreen do
    ...
    relationships do
      has_many :elements, AshUIExamples.Spacer.UiElement do
        destination_attribute(:screen_id)
      end

      has_many :bindings, AshUIExamples.Spacer.UiBinding do
        destination_attribute(:screen_id)
      end
    end
  ...
  defmodule UiElement do
    ...
    relationships do
      belongs_to :screen, AshUIExamples.Spacer.UiScreen do
        attribute_type(:uuid)
        allow_nil?(true)
      end
  ...
  defmodule UiBinding do
    ...
    relationships do
      belongs_to :element, AshUIExamples.Spacer.UiElement do
        attribute_type(:uuid)
        allow_nil?(true)
      end
  ...
  defmodule AuthoringDomain do
    ...
    resources do
      resource(AshUIExamples.Spacer.Examples.SpacerScreen)
      resource(AshUIExamples.Spacer.Examples.SpacerDemoPanelElement)
      resource(AshUIExamples.Spacer.Examples.SpacerSubjectElement)
      resource(AshUIExamples.Spacer.Examples.SpacerPreviewElement)
      resource(AshUIExamples.Spacer.Examples.SpacerStoryTextElement)
      resource(AshUIExamples.Spacer.Examples.SpacerSignalTextElement)
    end
  end
  ...
  defmodule ExampleElementBase do
    defmacro __using__(_opts) do
      quote do
        use Ash.Resource,
          domain: AshUIExamples.Spacer.AuthoringDomain,
          data_layer: Ash.DataLayer.Ets
  ...
  defmodule Examples.SpacerDemoPanelElement do
    use AshUIExamples.Spacer.ExampleElementBase

    relationships do
      has_many :subjects, AshUIExamples.Spacer.Examples.SpacerSubjectElement do
        destination_attribute(:parent_id)
      end

      has_many :previews, AshUIExamples.Spacer.Examples.SpacerPreviewElement do
        destination_attribute(:parent_id)
      end
    end
    ...
    ui_element do
      type(:card)
      props(%{title: "Spacer Example", class: "ashui-example-panel"})
      metadata(%{id: "example-spacer-demo", section: "demo", slot: "body", position: 0})
    end
  end

  defmodule Examples.SpacerSubjectElement do
    use AshUIExamples.Spacer.ExampleElementBase

    ui_element do
      type(:spacer)
      props(%{size: 32, class: "ashui-example-spacer"})
      metadata(%{id: "example-spacer-subject", section: "demo", slot: "body", position: 1})
    end
  end

  defmodule Examples.SpacerPreviewElement do
    use AshUIExamples.Spacer.ExampleElementBase
    ...
    ui_element do
      ...
      props(%{
        title: "Renderer note",
        value: "Spacer rendered through the public widget surface."
      })

      variants([:primary])
      metadata(%{id: "example-spacer-preview", section: "demo", slot: "body", position: 2})
    end

    ui_bindings do
      binding :preview_value do
        source(%{resource: "ExampleState", field: :status, id: "state-spacer"})
        target("value")
        binding_type(:value)
        transform(%{})
  ...
  defmodule Examples.SpacerStoryTextElement do
    use AshUIExamples.Spacer.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{id: "example-spacer-story", section: "story", slot: "body", position: 10})
    end
  end

  defmodule Examples.SpacerSignalTextElement do
    use AshUIExamples.Spacer.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{
        id: "example-spacer-signal-preview",
  ...
  defmodule Examples.SpacerScreen do
    use Ash.Resource,
      domain: AshUIExamples.Spacer.AuthoringDomain,
      data_layer: Ash.DataLayer.Ets
    ...
    relationships do
      has_many :demo_panels, AshUIExamples.Spacer.Examples.SpacerDemoPanelElement do
        destination_attribute(:screen_id)
      end

      has_many :story_texts, AshUIExamples.Spacer.Examples.SpacerStoryTextElement do
        destination_attribute(:screen_id)
      end

      has_many :signal_texts, AshUIExamples.Spacer.Examples.SpacerSignalTextElement do
        destination_attribute(:screen_id)
      end
    end
    ...
    ui_screen do
      ...
      metadata(%{
        title: "Spacer Example",
        example_directory: "spacer",
        shell_id: "example-spacer-shell"
      })
    end
  end

  defmodule ExampleSeeds do
    def seed!(opts \\ []), do: AshUIExamples.Spacer.seed!(opts)
    def reset!, do: AshUIExamples.Spacer.reset!()
  end
  ...
  defmodule Web.Router do
    ...
    scope "/", AshUIExamples.Spacer.Web do
  ...
  defmodule Web.Endpoint do
    use Phoenix.Endpoint, otp_app: :ash_ui_example_spacer
    ...
    plug(AshUIExamples.Spacer.Web.Router)
  end
  ...
  defmodule Web.ExampleLive do
    ...
    alias AshUIExamples.Spacer.Web.Components.ExampleShell
    alias AshUI.LiveView.EventHandler
    alias AshUI.LiveView.Integration

    def mount(params, _session, socket) do
      _ = AshUIExamples.Spacer.seed!()
      example_runtime = runtime_from_params(params)

      socket =
        socket
        |> Phoenix.Component.assign(:current_user, AshUIExamples.Spacer.current_user())
        |> Phoenix.Component.assign(:ash_ui_storage, AshUIExamples.Spacer.ui_storage())
        |> Phoenix.Component.assign(:ash_ui_domains, AshUIExamples.Spacer.runtime_domains())
        |> Phoenix.Component.assign(:page_title, "Spacer Example")
        |> Phoenix.Component.assign(:example_directory, "spacer")
        |> Phoenix.Component.assign(:theme_css, AshUIExamples.Spacer.theme_css())
        |> Phoenix.Component.assign(:example_runtime, example_runtime)
        |> Phoenix.Component.assign(
          :supported_runtimes,
          AshUIExamples.Spacer.supported_runtimes()
        )

      with {:ok, socket} <- Integration.mount_ui_screen(socket, "example/spacer", params),
    ...
    def render(assigns) do
      assigns =
        ...
        |> Phoenix.Component.assign_new(:example_runtime, fn ->
          AshUIExamples.Spacer.default_runtime()
        end)
        |> Phoenix.Component.assign_new(:rendered_runtime, fn ->
          %{
            content: assigns[:rendered_ui] || "",
            description:
              AshUIExamples.Spacer.runtime_description(AshUIExamples.Spacer.default_runtime()),
            mode: :live_fragment,
            runtime: AshUIExamples.Spacer.default_runtime()
          }
        end)
      ...
      <ExampleShell.example_shell
        ...
        summary={"Meaningful Interaction Story: verify the authored spacer creates intentional breathing room inside the shared review shell without introducing fake container semantics."}
        theme_css={@theme_css}
      >
    ...
    defp refresh_rendered_ui(socket) do
      rendered_runtime =
        AshUIExamples.Spacer.rendered_runtime(
          socket.assigns,
          socket.assigns[:example_runtime] || AshUIExamples.Spacer.default_runtime()
        )
    ...
    defp runtime_from_params(params) do
      params["runtime"]
      |> fallback_runtime()
      |> AshUIExamples.Spacer.normalize_runtime!()
    end
