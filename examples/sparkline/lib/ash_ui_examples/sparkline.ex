defmodule AshUIExamples.Sparkline do
  @moduledoc """
  Standalone resource-authority Ash UI app for the `sparkline` example.
  """
  ...
  @definition %{
    ...
    subject_children: [
      %{
        ...
        type: :button,
        slot: :actions,
        key: :load_latency_sparkline_button,
        children: [],
        actions: [
          %{
            id: :action_load_latency_sparkline_button,
            metadata: %{
            ...
            transform: %{
              params: %{
                status: %{
                  "from" => "static",
                  "value" => "Sparkline mounted with the queue-latency trend."
                },
                current_value: %{"from" => "static", "value" => "queue latency"},
                series: %{
                  "from" => "static",
                  "value" => [
                    %{"label" => "00m", "value" => 18},
      ...
      %{
        ...
        type: :button,
        slot: :actions,
        key: :load_backlog_sparkline_button,
        children: [],
        actions: [
          %{
            id: :action_load_backlog_sparkline_button,
            metadata: %{
              intent: "update_example_state",
              success_message: "Layered state updated"
            },
            ...
            transform: %{
              params: %{
                status: %{
                  "from" => "static",
                  "value" => "Sparkline switched to the worker-backlog trend."
                },
                current_value: %{"from" => "static", "value" => "worker backlog"},
                series: %{
                  "from" => "static",
                  "value" => [
                    %{"label" => "00m", "value" => 8},
  ...
  def app, do: :ash_ui_example_sparkline
  ...
  def ui_storage do
    [
      domain: AshUIExamples.Sparkline.UiStorageDomain,
      resources: [
        screen: AshUIExamples.Sparkline.UiScreen,
        element: AshUIExamples.Sparkline.UiElement,
        binding: AshUIExamples.Sparkline.UiBinding
      ],
      repo: nil
    ]
  end
  ...
  def reset! do
    reset_resource!(
      AshUIExamples.Sparkline.Runtime.ExampleState,
      AshUIExamples.Sparkline.RuntimeDomain
    )

    reset_resource!(AshUIExamples.Sparkline.UiBinding, AshUIExamples.Sparkline.UiStorageDomain)
    reset_resource!(AshUIExamples.Sparkline.UiElement, AshUIExamples.Sparkline.UiStorageDomain)
    reset_resource!(AshUIExamples.Sparkline.UiScreen, AshUIExamples.Sparkline.UiStorageDomain)
    :ok
  end
  ...
  def seed!(opts \\ []) do
    ...
    {:ok, screen} =
      Authority.create(
        AshUIExamples.Sparkline.Examples.SparklineScreen,
        actor: actor,
        name: @screen_name,
  ...
  defmodule Application do
    ...
    def start(_type, _args) do
      children = [
        {Phoenix.PubSub, name: AshUIExamples.Sparkline.PubSub},
        AshUIExamples.Sparkline.Web.Endpoint
      ]
  ...
  defmodule RuntimeDomain do
    ...
    resources do
      resource(AshUIExamples.Sparkline.Runtime.ExampleState)
    end
  end
  ...
  defmodule UiStorageDomain do
    ...
    resources do
      resource(AshUIExamples.Sparkline.UiScreen)
      resource(AshUIExamples.Sparkline.UiElement)
      resource(AshUIExamples.Sparkline.UiBinding)
    end
  end
  ...
  defmodule UiScreen do
    ...
    relationships do
      has_many :elements, AshUIExamples.Sparkline.UiElement do
        destination_attribute(:screen_id)
      end

      has_many :bindings, AshUIExamples.Sparkline.UiBinding do
        destination_attribute(:screen_id)
      end
    end
  ...
  defmodule UiElement do
    ...
    relationships do
      belongs_to :screen, AshUIExamples.Sparkline.UiScreen do
        attribute_type(:uuid)
        allow_nil?(true)
      end
  ...
  defmodule UiBinding do
    ...
    relationships do
      belongs_to :element, AshUIExamples.Sparkline.UiElement do
        attribute_type(:uuid)
        allow_nil?(true)
      end
  ...
  defmodule AuthoringDomain do
    ...
    resources do
      resource(AshUIExamples.Sparkline.Examples.SparklineScreen)
      resource(AshUIExamples.Sparkline.Examples.SparklineDemoPanelElement)
      resource(AshUIExamples.Sparkline.Examples.SparklineSubjectElement)
      resource(AshUIExamples.Sparkline.Examples.SparklinePreviewElement)
      resource(AshUIExamples.Sparkline.Examples.SparklineStoryTextElement)
      resource(AshUIExamples.Sparkline.Examples.SparklineSignalTextElement)
      resource(AshUIExamples.Sparkline.Examples.SparklineSupportNoticeElement)
      resource(AshUIExamples.Sparkline.Examples.SparklineLoadLatencySparklineButtonElement)
      resource(AshUIExamples.Sparkline.Examples.SparklineLoadBacklogSparklineButtonElement)
      resource(AshUIExamples.Sparkline.Examples.SparklineSparklineFooterElement)
    end
  end
  ...
  defmodule ExampleElementBase do
    defmacro __using__(_opts) do
      quote do
        use Ash.Resource,
          domain: AshUIExamples.Sparkline.AuthoringDomain,
          data_layer: Ash.DataLayer.Ets
  ...
  defmodule Examples.SparklineDemoPanelElement do
    use AshUIExamples.Sparkline.ExampleElementBase

    relationships do
      has_many :subjects, AshUIExamples.Sparkline.Examples.SparklineSubjectElement do
        destination_attribute(:parent_id)
      end

      has_many :previews, AshUIExamples.Sparkline.Examples.SparklinePreviewElement do
        destination_attribute(:parent_id)
      end

      has_many :support_notices, AshUIExamples.Sparkline.Examples.SparklineSupportNoticeElement do
        destination_attribute(:parent_id)
      end
    end
    ...
    ui_element do
      type(:card)
      props(%{title: "Sparkline Example", class: "ashui-example-panel"})
      metadata(%{id: "example-sparkline-demo", section: "demo", slot: "body", position: 0})
    end
  end

  defmodule Examples.SparklineSubjectElement do
    use AshUIExamples.Sparkline.ExampleElementBase

    relationships do
      has_many :load_latency_sparkline_button_elements,
               AshUIExamples.Sparkline.Examples.SparklineLoadLatencySparklineButtonElement do
        destination_attribute(:parent_id)
      end

      has_many :load_backlog_sparkline_button_elements,
               AshUIExamples.Sparkline.Examples.SparklineLoadBacklogSparklineButtonElement do
        destination_attribute(:parent_id)
      end

      has_many :sparkline_footer_elements,
               AshUIExamples.Sparkline.Examples.SparklineSparklineFooterElement do
        destination_attribute(:parent_id)
      end
    end

    ui_relationships do
      relationship :load_latency_sparkline_button_elements do
        kind(:child)
        slot(:actions)
        placement(:append)
        order(0)
      ...
      relationship :load_backlog_sparkline_button_elements do
        kind(:child)
        slot(:actions)
        placement(:append)
        order(10)
      ...
      relationship :sparkline_footer_elements do
        kind(:child)
        slot(:footer)
        placement(:append)
        order(0)
    ...
    ui_element do
      ...
      metadata(%{id: "example-sparkline-subject", section: "demo", slot: "body", position: 1})
    end

    ui_bindings do
      binding :sparkline_series do
        source(%{resource: "ExampleState", field: :series, id: "state-sparkline"})
        target("series")
        binding_type(:value)
        transform(%{})
  ...
  defmodule Examples.SparklineLoadLatencySparklineButtonElement do
    use AshUIExamples.Sparkline.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{
        id: "load-latency-sparkline-button",
        position: 0,
        slot: "actions",
        section: "demo"
      })
    ...
    ui_actions do
      action :action_load_latency_sparkline_button do
        signal(:click)
        source(%{id: "state-sparkline", resource: "ExampleState", action: "update"})
        target("submit")
  ...
  defmodule Examples.SparklineLoadBacklogSparklineButtonElement do
    use AshUIExamples.Sparkline.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{
        id: "load-backlog-sparkline-button",
        position: 10,
        slot: "actions",
        section: "demo"
      })
    ...
    ui_actions do
      action :action_load_backlog_sparkline_button do
        signal(:click)
        source(%{id: "state-sparkline", resource: "ExampleState", action: "update"})
        target("submit")
  ...
  defmodule Examples.SparklineSparklineFooterElement do
    use AshUIExamples.Sparkline.ExampleElementBase
    ...
    ui_bindings do
      binding :sparkline_footer_binding do
        source(%{id: "state-sparkline", resource: "ExampleState", field: :status})
        target("content")
        binding_type(:value)
        transform(%{})
        metadata(%{owner: "footer"})
  ...
  defmodule Examples.SparklinePreviewElement do
    use AshUIExamples.Sparkline.ExampleElementBase

    ui_element do
      type(:stat)
      props(%{title: "Series", value: "queue latency"})
      variants([:primary])
      metadata(%{id: "example-sparkline-preview", section: "demo", slot: "body", position: 2})
    end

    ui_bindings do
      binding :preview_value do
        source(%{resource: "ExampleState", field: :current_value, id: "state-sparkline"})
        target("value")
        binding_type(:value)
        transform(%{})
  ...
  defmodule Examples.SparklineStoryTextElement do
    use AshUIExamples.Sparkline.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{id: "example-sparkline-story", section: "story", slot: "body", position: 10})
    end
  end

  defmodule Examples.SparklineSignalTextElement do
    use AshUIExamples.Sparkline.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{
        id: "example-sparkline-signal-preview",
  ...
  defmodule Examples.SparklineSupportNoticeElement do
    use AshUIExamples.Sparkline.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{
        id: "example-sparkline-support-note",
        section: "demo",
        slot: "body",
        position: 3
      })
  ...
  defmodule Examples.SparklineScreen do
    use Ash.Resource,
      domain: AshUIExamples.Sparkline.AuthoringDomain,
      data_layer: Ash.DataLayer.Ets
    ...
    relationships do
      has_many :demo_panels, AshUIExamples.Sparkline.Examples.SparklineDemoPanelElement do
        destination_attribute(:screen_id)
      end

      has_many :story_texts, AshUIExamples.Sparkline.Examples.SparklineStoryTextElement do
        destination_attribute(:screen_id)
      end

      has_many :signal_texts, AshUIExamples.Sparkline.Examples.SparklineSignalTextElement do
        destination_attribute(:screen_id)
      end
    end
    ...
    ui_screen do
      ...
      metadata(%{
        title: "Sparkline Example",
        example_directory: "sparkline",
        shell_id: "example-sparkline-shell"
      })
    end
  end

  defmodule ExampleSeeds do
    def seed!(opts \\ []), do: AshUIExamples.Sparkline.seed!(opts)
    def reset!, do: AshUIExamples.Sparkline.reset!()
  end
  ...
  defmodule Web.Router do
    ...
    scope "/", AshUIExamples.Sparkline.Web do
  ...
  defmodule Web.Endpoint do
    use Phoenix.Endpoint, otp_app: :ash_ui_example_sparkline
    ...
    plug(AshUIExamples.Sparkline.Web.Router)
  end
  ...
  defmodule Web.ExampleLive do
    ...
    alias AshUIExamples.Sparkline.Web.Components.ExampleShell
    alias AshUI.LiveView.EventHandler
    alias AshUI.LiveView.Integration

    def mount(params, _session, socket) do
      _ = AshUIExamples.Sparkline.seed!()
      example_runtime = runtime_from_params(params)

      socket =
        socket
        |> Phoenix.Component.assign(:current_user, AshUIExamples.Sparkline.current_user())
        |> Phoenix.Component.assign(:ash_ui_storage, AshUIExamples.Sparkline.ui_storage())
        |> Phoenix.Component.assign(:ash_ui_domains, AshUIExamples.Sparkline.runtime_domains())
        |> Phoenix.Component.assign(:page_title, "Sparkline Example")
        |> Phoenix.Component.assign(:example_directory, "sparkline")
        |> Phoenix.Component.assign(:theme_css, AshUIExamples.Sparkline.theme_css())
        |> Phoenix.Component.assign(:example_runtime, example_runtime)
        |> Phoenix.Component.assign(
          :supported_runtimes,
          AshUIExamples.Sparkline.supported_runtimes()
        )

      with {:ok, socket} <- Integration.mount_ui_screen(socket, "example/sparkline", params),
    ...
    def render(assigns) do
      assigns =
        ...
        |> Phoenix.Component.assign_new(:example_runtime, fn ->
          AshUIExamples.Sparkline.default_runtime()
        end)
        |> Phoenix.Component.assign_new(:rendered_runtime, fn ->
          %{
            content: assigns[:rendered_ui] || "",
            description:
              AshUIExamples.Sparkline.runtime_description(
                AshUIExamples.Sparkline.default_runtime()
              ),
            mode: :live_fragment,
            runtime: AshUIExamples.Sparkline.default_runtime()
          }
        end)
      ...
      <ExampleShell.example_shell
        ...
        summary={"Meaningful Interaction Story: switch the active mini-series and confirm the sparkline redraws its trend points from persisted runtime data."}
        theme_css={@theme_css}
      >
    ...
    defp refresh_rendered_ui(socket) do
      rendered_runtime =
        AshUIExamples.Sparkline.rendered_runtime(
          socket.assigns,
          socket.assigns[:example_runtime] || AshUIExamples.Sparkline.default_runtime()
        )
    ...
    defp runtime_from_params(params) do
      params["runtime"]
      |> fallback_runtime()
      |> AshUIExamples.Sparkline.normalize_runtime!()
    end
