defmodule AshUIExamples.Status do
  @moduledoc """
  Standalone resource-authority Ash UI app for the `status` example.
  """
  ...
  @definition %{
    ...
    subject_children: [
      %{
        ...
        type: :button,
        slot: :actions,
        key: :load_healthy_status_button,
        children: [],
        actions: [
          %{
            id: :action_load_healthy_status_button,
            metadata: %{
            ...
            transform: %{
              params: %{
                status: %{
                  "from" => "static",
                  "value" => "Status surface switched to the healthy signal."
                },
                current_value: %{"from" => "static", "value" => "healthy"},
                metric: %{
                  "from" => "static",
                  "value" => %{
      ...
      %{
        ...
        type: :button,
        slot: :actions,
        key: :load_risk_status_button,
        children: [],
        actions: [
          %{
            id: :action_load_risk_status_button,
            metadata: %{
              intent: "update_example_state",
              success_message: "Layered state updated"
            },
            ...
            transform: %{
              params: %{
                status: %{
                  "from" => "static",
                  "value" => "Status surface switched to the risk signal."
                },
                current_value: %{"from" => "static", "value" => "risk"},
                metric: %{
                  "from" => "static",
                  "value" => %{
  ...
  def app, do: :ash_ui_example_status
  ...
  def ui_storage do
    [
      domain: AshUIExamples.Status.UiStorageDomain,
      resources: [
        screen: AshUIExamples.Status.UiScreen,
        element: AshUIExamples.Status.UiElement,
        binding: AshUIExamples.Status.UiBinding
      ],
      repo: nil
    ]
  end
  ...
  def reset! do
    reset_resource!(AshUIExamples.Status.Runtime.ExampleState, AshUIExamples.Status.RuntimeDomain)
    reset_resource!(AshUIExamples.Status.UiBinding, AshUIExamples.Status.UiStorageDomain)
    reset_resource!(AshUIExamples.Status.UiElement, AshUIExamples.Status.UiStorageDomain)
    reset_resource!(AshUIExamples.Status.UiScreen, AshUIExamples.Status.UiStorageDomain)
    :ok
  end
  ...
  def seed!(opts \\ []) do
    ...
    {:ok, _state} =
      Ash.create(
        AshUIExamples.Status.Runtime.ExampleState,
        seed_state(),
    ...
    {:ok, screen} =
      Authority.create(
        AshUIExamples.Status.Examples.StatusScreen,
        actor: actor,
        name: @screen_name,
  ...
  defmodule Application do
    ...
    def start(_type, _args) do
      children = [
        {Phoenix.PubSub, name: AshUIExamples.Status.PubSub},
        AshUIExamples.Status.Web.Endpoint
      ]
  ...
  defmodule RuntimeDomain do
    ...
    resources do
      resource(AshUIExamples.Status.Runtime.ExampleState)
    end
  end
  ...
  defmodule UiStorageDomain do
    ...
    resources do
      resource(AshUIExamples.Status.UiScreen)
      resource(AshUIExamples.Status.UiElement)
      resource(AshUIExamples.Status.UiBinding)
    end
  end
  ...
  defmodule UiScreen do
    ...
    relationships do
      has_many :elements, AshUIExamples.Status.UiElement do
        destination_attribute(:screen_id)
      end

      has_many :bindings, AshUIExamples.Status.UiBinding do
        destination_attribute(:screen_id)
      end
    end
  ...
  defmodule UiElement do
    ...
    relationships do
      belongs_to :screen, AshUIExamples.Status.UiScreen do
        attribute_type(:uuid)
        allow_nil?(true)
      end
  ...
  defmodule UiBinding do
    ...
    relationships do
      belongs_to :element, AshUIExamples.Status.UiElement do
        attribute_type(:uuid)
        allow_nil?(true)
      end
  ...
  defmodule AuthoringDomain do
    ...
    resources do
      resource(AshUIExamples.Status.Examples.StatusScreen)
      resource(AshUIExamples.Status.Examples.StatusDemoPanelElement)
      resource(AshUIExamples.Status.Examples.StatusSubjectElement)
      resource(AshUIExamples.Status.Examples.StatusPreviewElement)
      resource(AshUIExamples.Status.Examples.StatusStoryTextElement)
      resource(AshUIExamples.Status.Examples.StatusSignalTextElement)
      resource(AshUIExamples.Status.Examples.StatusSupportNoticeElement)
      resource(AshUIExamples.Status.Examples.StatusLoadHealthyStatusButtonElement)
      resource(AshUIExamples.Status.Examples.StatusLoadRiskStatusButtonElement)
      resource(AshUIExamples.Status.Examples.StatusStatusFooterElement)
    end
  end
  ...
  defmodule ExampleElementBase do
    defmacro __using__(_opts) do
      quote do
        use Ash.Resource,
          domain: AshUIExamples.Status.AuthoringDomain,
          data_layer: Ash.DataLayer.Ets
  ...
  defmodule Examples.StatusDemoPanelElement do
    use AshUIExamples.Status.ExampleElementBase

    relationships do
      has_many :subjects, AshUIExamples.Status.Examples.StatusSubjectElement do
        destination_attribute(:parent_id)
      end

      has_many :previews, AshUIExamples.Status.Examples.StatusPreviewElement do
        destination_attribute(:parent_id)
      end

      has_many :support_notices, AshUIExamples.Status.Examples.StatusSupportNoticeElement do
        destination_attribute(:parent_id)
      end
    end
    ...
    ui_element do
      type(:card)
      props(%{title: "Status Example", class: "ashui-example-panel"})
      metadata(%{id: "example-status-demo", section: "demo", slot: "body", position: 0})
    end
  end

  defmodule Examples.StatusSubjectElement do
    use AshUIExamples.Status.ExampleElementBase

    relationships do
      has_many :load_healthy_status_button_elements,
               AshUIExamples.Status.Examples.StatusLoadHealthyStatusButtonElement do
        destination_attribute(:parent_id)
      end

      has_many :load_risk_status_button_elements,
               AshUIExamples.Status.Examples.StatusLoadRiskStatusButtonElement do
        destination_attribute(:parent_id)
      end

      has_many :status_footer_elements, AshUIExamples.Status.Examples.StatusStatusFooterElement do
        destination_attribute(:parent_id)
      end
    end

    ui_relationships do
      relationship :load_healthy_status_button_elements do
        kind(:child)
        slot(:actions)
        placement(:append)
        order(0)
      ...
      relationship :load_risk_status_button_elements do
        kind(:child)
        slot(:actions)
        placement(:append)
        order(10)
      ...
      relationship :status_footer_elements do
        kind(:child)
        slot(:footer)
        placement(:append)
        order(0)
    ...
    ui_element do
      ...
      metadata(%{id: "example-status-subject", section: "demo", slot: "body", position: 1})
    end

    ui_bindings do
      binding :status_metric do
        source(%{resource: "ExampleState", field: :metric, id: "state-status"})
        target("model")
        binding_type(:value)
        transform(%{})
  ...
  defmodule Examples.StatusLoadHealthyStatusButtonElement do
    use AshUIExamples.Status.ExampleElementBase

    ui_element do
      type(:button)

      props(%{label: "Healthy", class: "ashui-example-primary-cta", variant: "secondary"})

      metadata(%{
        id: "load-healthy-status-button",
        position: 0,
        slot: "actions",
        section: "demo"
      })
    ...
    ui_actions do
      action :action_load_healthy_status_button do
        signal(:click)
        source(%{id: "state-status", resource: "ExampleState", action: "update"})
        target("submit")
  ...
  defmodule Examples.StatusLoadRiskStatusButtonElement do
    use AshUIExamples.Status.ExampleElementBase

    ui_element do
      type(:button)

      props(%{label: "Risk", class: "ashui-example-secondary-cta", variant: "secondary"})

      metadata(%{id: "load-risk-status-button", position: 10, slot: "actions", section: "demo"})
    end

    ui_actions do
      action :action_load_risk_status_button do
        signal(:click)
        source(%{id: "state-status", resource: "ExampleState", action: "update"})
        target("submit")
  ...
  defmodule Examples.StatusStatusFooterElement do
    use AshUIExamples.Status.ExampleElementBase
    ...
    ui_bindings do
      binding :status_footer_binding do
        source(%{id: "state-status", resource: "ExampleState", field: :status})
        target("content")
        binding_type(:value)
        transform(%{})
        metadata(%{owner: "footer"})
  ...
  defmodule Examples.StatusPreviewElement do
    use AshUIExamples.Status.ExampleElementBase

    ui_element do
      type(:stat)
      props(%{title: "Current signal", value: "watching"})
      variants([:primary])
      metadata(%{id: "example-status-preview", section: "demo", slot: "body", position: 2})
    end

    ui_bindings do
      binding :preview_value do
        source(%{resource: "ExampleState", field: :current_value, id: "state-status"})
        target("value")
        binding_type(:value)
        transform(%{})
  ...
  defmodule Examples.StatusStoryTextElement do
    use AshUIExamples.Status.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{id: "example-status-story", section: "story", slot: "body", position: 10})
    end
  end

  defmodule Examples.StatusSignalTextElement do
    use AshUIExamples.Status.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{
        id: "example-status-signal-preview",
  ...
  defmodule Examples.StatusSupportNoticeElement do
    use AshUIExamples.Status.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{id: "example-status-support-note", section: "demo", slot: "body", position: 3})
    end
  end

  defmodule Examples.StatusScreen do
    use Ash.Resource,
      domain: AshUIExamples.Status.AuthoringDomain,
      data_layer: Ash.DataLayer.Ets
    ...
    relationships do
      has_many :demo_panels, AshUIExamples.Status.Examples.StatusDemoPanelElement do
        destination_attribute(:screen_id)
      end

      has_many :story_texts, AshUIExamples.Status.Examples.StatusStoryTextElement do
        destination_attribute(:screen_id)
      end

      has_many :signal_texts, AshUIExamples.Status.Examples.StatusSignalTextElement do
        destination_attribute(:screen_id)
      end
    end
    ...
    ui_screen do
      ...
      metadata(%{
        title: "Status Example",
        example_directory: "status",
        shell_id: "example-status-shell"
      })
    end
  end

  defmodule ExampleSeeds do
    def seed!(opts \\ []), do: AshUIExamples.Status.seed!(opts)
    def reset!, do: AshUIExamples.Status.reset!()
  end
  ...
  defmodule Web.Router do
    ...
    scope "/", AshUIExamples.Status.Web do
  ...
  defmodule Web.Endpoint do
    use Phoenix.Endpoint, otp_app: :ash_ui_example_status
    ...
    plug(AshUIExamples.Status.Web.Router)
  end
  ...
  defmodule Web.ExampleLive do
    ...
    alias AshUIExamples.Status.Web.Components.ExampleShell
    alias AshUI.LiveView.EventHandler
    alias AshUI.LiveView.Integration

    def mount(params, _session, socket) do
      _ = AshUIExamples.Status.seed!()
      example_runtime = runtime_from_params(params)

      socket =
        socket
        |> Phoenix.Component.assign(:current_user, AshUIExamples.Status.current_user())
        |> Phoenix.Component.assign(:ash_ui_storage, AshUIExamples.Status.ui_storage())
        |> Phoenix.Component.assign(:ash_ui_domains, AshUIExamples.Status.runtime_domains())
        |> Phoenix.Component.assign(:page_title, "Status Example")
        |> Phoenix.Component.assign(:example_directory, "status")
        |> Phoenix.Component.assign(:theme_css, AshUIExamples.Status.theme_css())
        |> Phoenix.Component.assign(:example_runtime, example_runtime)
        |> Phoenix.Component.assign(
          :supported_runtimes,
          AshUIExamples.Status.supported_runtimes()
        )

      with {:ok, socket} <- Integration.mount_ui_screen(socket, "example/status", params),
    ...
    def render(assigns) do
      assigns =
        ...
        |> Phoenix.Component.assign_new(:example_runtime, fn ->
          AshUIExamples.Status.default_runtime()
        end)
        |> Phoenix.Component.assign_new(:rendered_runtime, fn ->
          %{
            content: assigns[:rendered_ui] || "",
            description:
              AshUIExamples.Status.runtime_description(AshUIExamples.Status.default_runtime()),
            mode: :live_fragment,
            runtime: AshUIExamples.Status.default_runtime()
          }
        end)
      ...
      <ExampleShell.example_shell
        ...
        summary={"Meaningful Interaction Story: switch the operational health state and confirm the status surface updates its visible tone and detail from persisted runtime data."}
        theme_css={@theme_css}
      >
    ...
    defp refresh_rendered_ui(socket) do
      rendered_runtime =
        AshUIExamples.Status.rendered_runtime(
          socket.assigns,
          socket.assigns[:example_runtime] || AshUIExamples.Status.default_runtime()
        )
    ...
    defp runtime_from_params(params) do
      params["runtime"]
      |> fallback_runtime()
      |> AshUIExamples.Status.normalize_runtime!()
    end
