...
config :ash_ui_example_stream_widget,
  ecto_repos: []

config :ash_ui_example_stream_widget, AshUIExamples.StreamWidget.Web.Endpoint,
  url: [host: "127.0.0.1"],
...
config :ash_ui, :ash_domains, [AshUIExamples.StreamWidget.RuntimeDomain]
