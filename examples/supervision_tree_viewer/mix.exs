defmodule AshUIExamples.SupervisionTreeViewer.MixProject do
  use Mix.Project
  ...
  def project do
    [
      app: :ash_ui_example_supervision_tree_viewer,
      version: "0.1.0",
      elixir: "~> 1.15",
  ...
  def application do
    [
      mod: {AshUIExamples.SupervisionTreeViewer.Application, []},
