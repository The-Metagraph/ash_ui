defmodule AshUIExamples.Tabs do
  @moduledoc """
  Standalone resource-authority Ash UI app for the `tabs` example.
  """
  ...
  @definition %{
    ...
    subject_children: [
      %{
        ...
        actions: [
          %{
            ...
            transform: %{
              params: %{
                status: %{"from" => "static", "value" => "Overview tab selected."},
      ...
      %{
        ...
        actions: [
          %{
            ...
            transform: %{
              params: %{
                status: %{"from" => "static", "value" => "Metrics tab selected."},
                selected_value: %{"from" => "static", "value" => "metrics"}
              }
            }
          }
        ],
      ...
      %{
        ...
        type: :button,
        slot: :nav,
        key: :escalations_tab_button,
        children: [],
        actions: [
          %{
            id: :select_escalations,
            metadata: %{
              intent: "select_navigation",
              success_message: "Selection updated"
            },
            ...
            transform: %{
              params: %{
                status: %{
                  "from" => "static",
                  "value" => "Escalations tab selected."
                },
                selected_value: %{"from" => "static", "value" => "escalations"}
              }
            }
          }
        ],
      ...
      %{
        ...
        bindings: [
          %{
            ...
            source: %{id: "state-tabs", resource: "ExampleState", field: :status},
            target: "content",
            transform: %{},
            binding_type: :value
          }
  ...
  def app, do: :ash_ui_example_tabs
  ...
  def runtime_domains, do: [AshUIExamples.Tabs.RuntimeDomain]

  def current_user,
    do: %{active: true, id: "reviewer-tabs", name: "Example Reviewer", role: :admin}
  ...
  def reset! do
    reset_resource!(AshUIExamples.Tabs.Runtime.ExampleState, AshUIExamples.Tabs.RuntimeDomain)
    reset_resource!(AshUIExamples.Tabs.UiBinding, AshUIExamples.Tabs.UiStorageDomain)
    reset_resource!(AshUIExamples.Tabs.UiElement, AshUIExamples.Tabs.UiStorageDomain)
    reset_resource!(AshUIExamples.Tabs.UiScreen, AshUIExamples.Tabs.UiStorageDomain)
    :ok
  end
  ...
  def seed!(opts \\ []) do
    ...
    {:ok, _state} =
      Ash.create(
        AshUIExamples.Tabs.Runtime.ExampleState,
        seed_state(),
        domain: AshUIExamples.Tabs.RuntimeDomain,
        authorize?: false
      )

    {:ok, screen} =
      Authority.create(
        AshUIExamples.Tabs.Examples.TabsScreen,
        actor: actor,
        name: @screen_name,
  ...
  defmodule Application do
    ...
    def start(_type, _args) do
      children = [
        {Phoenix.PubSub, name: AshUIExamples.Tabs.PubSub},
        AshUIExamples.Tabs.Web.Endpoint
      ]
  ...
  defmodule RuntimeDomain do
    ...
    resources do
      resource(AshUIExamples.Tabs.Runtime.ExampleState)
    end
  end

  defmodule Runtime.ExampleState do
    use Ash.Resource, domain: AshUIExamples.Tabs.RuntimeDomain, data_layer: Ash.DataLayer.Ets
  ...
  defmodule UiStorageDomain do
    ...
    resources do
      resource(AshUIExamples.Tabs.UiScreen)
      resource(AshUIExamples.Tabs.UiElement)
      resource(AshUIExamples.Tabs.UiBinding)
    end
  end
  ...
  defmodule UiScreen do
    ...
    relationships do
      has_many :elements, AshUIExamples.Tabs.UiElement do
        destination_attribute(:screen_id)
      end

      has_many :bindings, AshUIExamples.Tabs.UiBinding do
        destination_attribute(:screen_id)
      end
    end
  ...
  defmodule UiElement do
    ...
    relationships do
      belongs_to :screen, AshUIExamples.Tabs.UiScreen do
        attribute_type(:uuid)
        allow_nil?(true)
      end
  ...
  defmodule UiBinding do
    ...
    relationships do
      belongs_to :element, AshUIExamples.Tabs.UiElement do
        attribute_type(:uuid)
        allow_nil?(true)
      end
  ...
  defmodule AuthoringDomain do
    ...
    resources do
      resource(AshUIExamples.Tabs.Examples.TabsScreen)
      resource(AshUIExamples.Tabs.Examples.TabsDemoPanelElement)
      resource(AshUIExamples.Tabs.Examples.TabsSubjectElement)
      resource(AshUIExamples.Tabs.Examples.TabsPreviewElement)
      resource(AshUIExamples.Tabs.Examples.TabsStoryTextElement)
      resource(AshUIExamples.Tabs.Examples.TabsSignalTextElement)
      resource(AshUIExamples.Tabs.Examples.TabsSupportNoticeElement)
      resource(AshUIExamples.Tabs.Examples.TabsOverviewTabButtonElement)
      resource(AshUIExamples.Tabs.Examples.TabsMetricsTabButtonElement)
      resource(AshUIExamples.Tabs.Examples.TabsEscalationsTabButtonElement)
      resource(AshUIExamples.Tabs.Examples.TabsActivePanelElement)
      resource(AshUIExamples.Tabs.Examples.TabsTabsStatusElement)
    end
  end
  ...
  defmodule ExampleElementBase do
    defmacro __using__(_opts) do
      quote do
        use Ash.Resource,
          domain: AshUIExamples.Tabs.AuthoringDomain,
          data_layer: Ash.DataLayer.Ets
  ...
  defmodule Examples.TabsDemoPanelElement do
    use AshUIExamples.Tabs.ExampleElementBase

    relationships do
      has_many :subjects, AshUIExamples.Tabs.Examples.TabsSubjectElement do
        destination_attribute(:parent_id)
      end

      has_many :previews, AshUIExamples.Tabs.Examples.TabsPreviewElement do
        destination_attribute(:parent_id)
      end

      has_many :support_notices, AshUIExamples.Tabs.Examples.TabsSupportNoticeElement do
        destination_attribute(:parent_id)
      end
    end
    ...
    ui_element do
      type(:card)
      props(%{title: "Tabs Example", class: "ashui-example-panel"})
      metadata(%{id: "example-tabs-demo", section: "demo", slot: "body", position: 0})
    end
  end

  defmodule Examples.TabsSubjectElement do
    use AshUIExamples.Tabs.ExampleElementBase

    relationships do
      has_many :overview_tab_button_elements,
               AshUIExamples.Tabs.Examples.TabsOverviewTabButtonElement do
        destination_attribute(:parent_id)
      end

      has_many :metrics_tab_button_elements,
               AshUIExamples.Tabs.Examples.TabsMetricsTabButtonElement do
        destination_attribute(:parent_id)
      end

      has_many :escalations_tab_button_elements,
               AshUIExamples.Tabs.Examples.TabsEscalationsTabButtonElement do
        destination_attribute(:parent_id)
      end

      has_many :active_panel_elements, AshUIExamples.Tabs.Examples.TabsActivePanelElement do
        destination_attribute(:parent_id)
      end

      has_many :tabs_status_elements, AshUIExamples.Tabs.Examples.TabsTabsStatusElement do
        destination_attribute(:parent_id)
      end
    end

    ui_relationships do
      relationship :overview_tab_button_elements do
        kind(:child)
        slot(:nav)
        placement(:append)
        order(0)
      ...
      relationship :metrics_tab_button_elements do
        kind(:child)
        slot(:nav)
        placement(:append)
        order(10)
      ...
      relationship :escalations_tab_button_elements do
        kind(:child)
        slot(:nav)
        placement(:append)
        order(20)
      ...
      relationship :active_panel_elements do
        kind(:child)
        slot(:body)
        placement(:append)
        order(0)
      ...
      relationship :tabs_status_elements do
        kind(:child)
        slot(:footer)
        placement(:append)
        order(0)
    ...
    ui_element do
      ...
      metadata(%{id: "example-tabs-subject", section: "demo", slot: "body", position: 1})
    end
  end

  defmodule Examples.TabsOverviewTabButtonElement do
    use AshUIExamples.Tabs.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{id: "overview-tab-button", position: 0, slot: "nav", section: "demo"})
    end

    ui_actions do
      action :select_overview do
        signal(:click)
        source(%{id: "state-tabs", resource: "ExampleState", action: "update"})
        target("submit")
  ...
  defmodule Examples.TabsMetricsTabButtonElement do
    use AshUIExamples.Tabs.ExampleElementBase

    ui_element do
      type(:button)

      props(%{label: "Metrics", class: "ashui-example-nav-button", variant: "secondary"})

      metadata(%{id: "metrics-tab-button", position: 10, slot: "nav", section: "demo"})
    end

    ui_actions do
      action :select_metrics do
        signal(:click)
        source(%{id: "state-tabs", resource: "ExampleState", action: "update"})
        target("submit")
  ...
  defmodule Examples.TabsEscalationsTabButtonElement do
    use AshUIExamples.Tabs.ExampleElementBase

    ui_element do
      type(:button)

      props(%{label: "Escalations", class: "ashui-example-nav-button", variant: "secondary"})

      metadata(%{id: "escalations-tab-button", position: 20, slot: "nav", section: "demo"})
    end

    ui_actions do
      action :select_escalations do
        signal(:click)
        source(%{id: "state-tabs", resource: "ExampleState", action: "update"})
        target("submit")
        ...
        transform(%{
          params: %{
            status: %{"from" => "static", "value" => "Escalations tab selected."},
            selected_value: %{"from" => "static", "value" => "escalations"}
          }
        })
  ...
  defmodule Examples.TabsActivePanelElement do
    use AshUIExamples.Tabs.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{id: "active-panel", position: 0, slot: "body", section: "demo"})
    end

    ui_bindings do
      binding :tabs_selected_value do
        source(%{id: "state-tabs", resource: "ExampleState", field: :selected_value})
        target("content")
        binding_type(:value)
        transform(%{})
        metadata(%{owner: "panel"})
  ...
  defmodule Examples.TabsTabsStatusElement do
    use AshUIExamples.Tabs.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{id: "tabs-status", position: 0, slot: "footer", section: "demo"})
    end

    ui_bindings do
      binding :tabs_status_copy do
        source(%{id: "state-tabs", resource: "ExampleState", field: :status})
        target("content")
        binding_type(:value)
        transform(%{})
  ...
  defmodule Examples.TabsPreviewElement do
    use AshUIExamples.Tabs.ExampleElementBase

    ui_element do
      type(:stat)
      props(%{title: "Active tab", value: "overview"})
      variants([:primary])
      metadata(%{id: "example-tabs-preview", section: "demo", slot: "body", position: 2})
    end
  ...
  defmodule Examples.TabsStoryTextElement do
    use AshUIExamples.Tabs.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{id: "example-tabs-story", section: "story", slot: "body", position: 10})
    end
  end

  defmodule Examples.TabsSignalTextElement do
    use AshUIExamples.Tabs.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{
        id: "example-tabs-signal-preview",
  ...
  defmodule Examples.TabsSupportNoticeElement do
    use AshUIExamples.Tabs.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{id: "example-tabs-support-note", section: "demo", slot: "body", position: 3})
    end
  end

  defmodule Examples.TabsScreen do
    use Ash.Resource,
      domain: AshUIExamples.Tabs.AuthoringDomain,
      data_layer: Ash.DataLayer.Ets
    ...
    relationships do
      has_many :demo_panels, AshUIExamples.Tabs.Examples.TabsDemoPanelElement do
        destination_attribute(:screen_id)
      end

      has_many :story_texts, AshUIExamples.Tabs.Examples.TabsStoryTextElement do
        destination_attribute(:screen_id)
      end

      has_many :signal_texts, AshUIExamples.Tabs.Examples.TabsSignalTextElement do
        destination_attribute(:screen_id)
      end
    end
    ...
    ui_screen do
      ...
      metadata(%{
        title: "Tabs Example",
        example_directory: "tabs",
        shell_id: "example-tabs-shell"
      })
    end
  end

  defmodule ExampleSeeds do
    def seed!(opts \\ []), do: AshUIExamples.Tabs.seed!(opts)
    def reset!, do: AshUIExamples.Tabs.reset!()
  end
  ...
  defmodule Web.Router do
    ...
    scope "/", AshUIExamples.Tabs.Web do
  ...
  defmodule Web.Endpoint do
    use Phoenix.Endpoint, otp_app: :ash_ui_example_tabs
    ...
    plug(AshUIExamples.Tabs.Web.Router)
  end
  ...
  defmodule Web.ExampleLive do
    ...
    alias AshUIExamples.Tabs.Web.Components.ExampleShell
    alias AshUI.LiveView.EventHandler
    alias AshUI.LiveView.Integration

    def mount(params, _session, socket) do
      _ = AshUIExamples.Tabs.seed!()
      example_runtime = runtime_from_params(params)

      socket =
        socket
        |> Phoenix.Component.assign(:current_user, AshUIExamples.Tabs.current_user())
        |> Phoenix.Component.assign(:ash_ui_storage, AshUIExamples.Tabs.ui_storage())
        |> Phoenix.Component.assign(:ash_ui_domains, AshUIExamples.Tabs.runtime_domains())
        |> Phoenix.Component.assign(:page_title, "Tabs Example")
        |> Phoenix.Component.assign(:example_directory, "tabs")
        |> Phoenix.Component.assign(:theme_css, AshUIExamples.Tabs.theme_css())
        |> Phoenix.Component.assign(:example_runtime, example_runtime)
        |> Phoenix.Component.assign(:supported_runtimes, AshUIExamples.Tabs.supported_runtimes())

      with {:ok, socket} <- Integration.mount_ui_screen(socket, "example/tabs", params),
    ...
    def render(assigns) do
      assigns =
        ...
        |> Phoenix.Component.assign_new(:supported_runtimes, fn ->
          AshUIExamples.Tabs.supported_runtimes()
        end)
        |> Phoenix.Component.assign_new(:example_runtime, fn ->
          AshUIExamples.Tabs.default_runtime()
        end)
        |> Phoenix.Component.assign_new(:rendered_runtime, fn ->
          %{
            content: assigns[:rendered_ui] || "",
            description:
              AshUIExamples.Tabs.runtime_description(AshUIExamples.Tabs.default_runtime()),
            mode: :live_fragment,
            runtime: AshUIExamples.Tabs.default_runtime()
          }
        end)
      ...
      <ExampleShell.example_shell
        ...
        summary={"Meaningful Interaction Story: switch tabs and confirm the active panel value changes through nested public button resources while the outer subject remains an explicit `custom:tabs` shell."}
        theme_css={@theme_css}
      >
    ...
    defp refresh_rendered_ui(socket) do
      rendered_runtime =
        AshUIExamples.Tabs.rendered_runtime(
          socket.assigns,
          socket.assigns[:example_runtime] || AshUIExamples.Tabs.default_runtime()
        )
    ...
    defp runtime_from_params(params) do
      params["runtime"]
      |> fallback_runtime()
      |> AshUIExamples.Tabs.normalize_runtime!()
    end
