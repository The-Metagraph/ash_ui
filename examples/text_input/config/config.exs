...
config :ash_ui_example_text_input,
  ecto_repos: []

config :ash_ui_example_text_input, AshUIExamples.TextInput.Web.Endpoint,
  url: [host: "127.0.0.1"],
...
config :ash_ui, :ash_domains, [AshUIExamples.TextInput.RuntimeDomain]
