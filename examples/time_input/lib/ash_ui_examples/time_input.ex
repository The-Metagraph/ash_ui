defmodule AshUIExamples.TimeInput do
  @moduledoc """
  Standalone resource-authority Ash UI app for the `time_input` example.
  """
  ...
  @screen_name "example/time_input"
  @definition %{
    directory: "time_input",
    family: :input,
  ...
  def app, do: :ash_ui_example_time_input
  ...
  def runtime_domains, do: [AshUIExamples.TimeInput.RuntimeDomain]

  def current_user,
    do: %{
      active: true,
      id: "reviewer-time_input",
  ...
  def reset! do
    reset_resource!(
      AshUIExamples.TimeInput.Runtime.ExampleState,
      AshUIExamples.TimeInput.RuntimeDomain
    )

    reset_resource!(AshUIExamples.TimeInput.UiBinding, AshUIExamples.TimeInput.UiStorageDomain)
    reset_resource!(AshUIExamples.TimeInput.UiElement, AshUIExamples.TimeInput.UiStorageDomain)
    reset_resource!(AshUIExamples.TimeInput.UiScreen, AshUIExamples.TimeInput.UiStorageDomain)
    :ok
  end
  ...
  def seed!(opts \\ []) do
    ...
    {:ok, _state} =
      Ash.create(
        AshUIExamples.TimeInput.Runtime.ExampleState,
        seed_state(),
        domain: AshUIExamples.TimeInput.RuntimeDomain,
        authorize?: false
      )

    {:ok, screen} =
      Authority.create(
        AshUIExamples.TimeInput.Examples.TimeInputScreen,
        actor: actor,
        name: @screen_name,
  ...
  defmodule Application do
    ...
    def start(_type, _args) do
      children = [
        {Phoenix.PubSub, name: AshUIExamples.TimeInput.PubSub},
        AshUIExamples.TimeInput.Web.Endpoint
      ]
  ...
  defmodule RuntimeDomain do
    ...
    resources do
      resource(AshUIExamples.TimeInput.Runtime.ExampleState)
    end
  end

  defmodule Runtime.ExampleState do
    use Ash.Resource, domain: AshUIExamples.TimeInput.RuntimeDomain, data_layer: Ash.DataLayer.Ets
  ...
  defmodule UiStorageDomain do
    ...
    resources do
      resource(AshUIExamples.TimeInput.UiScreen)
      resource(AshUIExamples.TimeInput.UiElement)
      resource(AshUIExamples.TimeInput.UiBinding)
    end
  end
  ...
  defmodule UiScreen do
    ...
    relationships do
      has_many :elements, AshUIExamples.TimeInput.UiElement do
        destination_attribute(:screen_id)
      end

      has_many :bindings, AshUIExamples.TimeInput.UiBinding do
        destination_attribute(:screen_id)
      end
    end
  ...
  defmodule UiElement do
    ...
    relationships do
      belongs_to :screen, AshUIExamples.TimeInput.UiScreen do
        attribute_type(:uuid)
        allow_nil?(true)
      end
  ...
  defmodule UiBinding do
    ...
    relationships do
      belongs_to :element, AshUIExamples.TimeInput.UiElement do
        attribute_type(:uuid)
        allow_nil?(true)
      end
  ...
  defmodule AuthoringDomain do
    ...
    resources do
      resource(AshUIExamples.TimeInput.Examples.TimeInputScreen)
      resource(AshUIExamples.TimeInput.Examples.TimeInputDemoPanelElement)
      resource(AshUIExamples.TimeInput.Examples.TimeInputSubjectElement)
      resource(AshUIExamples.TimeInput.Examples.TimeInputPreviewElement)
      resource(AshUIExamples.TimeInput.Examples.TimeInputStoryTextElement)
      resource(AshUIExamples.TimeInput.Examples.TimeInputSignalTextElement)
    end
  end
  ...
  defmodule ExampleElementBase do
    defmacro __using__(_opts) do
      quote do
        use Ash.Resource,
          domain: AshUIExamples.TimeInput.AuthoringDomain,
          data_layer: Ash.DataLayer.Ets
  ...
  defmodule Examples.TimeInputDemoPanelElement do
    use AshUIExamples.TimeInput.ExampleElementBase

    relationships do
      has_many :subjects, AshUIExamples.TimeInput.Examples.TimeInputSubjectElement do
        destination_attribute(:parent_id)
      end

      has_many :previews, AshUIExamples.TimeInput.Examples.TimeInputPreviewElement do
        destination_attribute(:parent_id)
      end
    end
    ...
    ui_element do
      type(:card)
      props(%{title: "Time Input Example", class: "ashui-example-panel"})
      metadata(%{id: "example-time_input-demo", section: "demo", slot: "body", position: 0})
    end
  end

  defmodule Examples.TimeInputSubjectElement do
    use AshUIExamples.TimeInput.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{id: "example-time_input-subject", section: "demo", slot: "body", position: 1})
    end

    ui_bindings do
      binding :time_input_value do
        source(%{resource: "ExampleState", field: :current_value, id: "state-time_input"})
        target("value")
        binding_type(:value)
        transform(%{})
  ...
  defmodule Examples.TimeInputPreviewElement do
    use AshUIExamples.TimeInput.ExampleElementBase

    ui_element do
      type(:stat)
      props(%{title: "Selected time", value: "09:30"})
      variants([:primary])
      metadata(%{id: "example-time_input-preview", section: "demo", slot: "body", position: 2})
    end
  ...
  defmodule Examples.TimeInputStoryTextElement do
    use AshUIExamples.TimeInput.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{id: "example-time_input-story", section: "story", slot: "body", position: 10})
    end
  end

  defmodule Examples.TimeInputSignalTextElement do
    use AshUIExamples.TimeInput.ExampleElementBase
    ...
    ui_element do
      ...
      metadata(%{
        id: "example-time_input-signal-preview",
  ...
  defmodule Examples.TimeInputScreen do
    use Ash.Resource,
      domain: AshUIExamples.TimeInput.AuthoringDomain,
      data_layer: Ash.DataLayer.Ets
    ...
    relationships do
      has_many :demo_panels, AshUIExamples.TimeInput.Examples.TimeInputDemoPanelElement do
        destination_attribute(:screen_id)
      end

      has_many :story_texts, AshUIExamples.TimeInput.Examples.TimeInputStoryTextElement do
        destination_attribute(:screen_id)
      end

      has_many :signal_texts, AshUIExamples.TimeInput.Examples.TimeInputSignalTextElement do
        destination_attribute(:screen_id)
      end
    end
    ...
    ui_screen do
      ...
      metadata(%{
        title: "Time Input Example",
        example_directory: "time_input",
        shell_id: "example-time_input-shell"
      })
    end
  end

  defmodule ExampleSeeds do
    def seed!(opts \\ []), do: AshUIExamples.TimeInput.seed!(opts)
    def reset!, do: AshUIExamples.TimeInput.reset!()
  end
  ...
  defmodule Web.Router do
    ...
    scope "/", AshUIExamples.TimeInput.Web do
  ...
  defmodule Web.Endpoint do
    use Phoenix.Endpoint, otp_app: :ash_ui_example_time_input
    ...
    plug(AshUIExamples.TimeInput.Web.Router)
  end
  ...
  defmodule Web.ExampleLive do
    ...
    alias AshUIExamples.TimeInput.Web.Components.ExampleShell
    alias AshUI.LiveView.EventHandler
    alias AshUI.LiveView.Integration

    def mount(params, _session, socket) do
      _ = AshUIExamples.TimeInput.seed!()
      example_runtime = runtime_from_params(params)

      socket =
        socket
        |> Phoenix.Component.assign(:current_user, AshUIExamples.TimeInput.current_user())
        |> Phoenix.Component.assign(:ash_ui_storage, AshUIExamples.TimeInput.ui_storage())
        |> Phoenix.Component.assign(:ash_ui_domains, AshUIExamples.TimeInput.runtime_domains())
        |> Phoenix.Component.assign(:page_title, "Time Input Example")
        |> Phoenix.Component.assign(:example_directory, "time_input")
        |> Phoenix.Component.assign(:theme_css, AshUIExamples.TimeInput.theme_css())
        |> Phoenix.Component.assign(:example_runtime, example_runtime)
        |> Phoenix.Component.assign(
          :supported_runtimes,
          AshUIExamples.TimeInput.supported_runtimes()
        )

      with {:ok, socket} <- Integration.mount_ui_screen(socket, "example/time_input", params),
    ...
    def render(assigns) do
      assigns =
        ...
        |> Phoenix.Component.assign_new(:example_runtime, fn ->
          AshUIExamples.TimeInput.default_runtime()
        end)
        |> Phoenix.Component.assign_new(:rendered_runtime, fn ->
          %{
            content: assigns[:rendered_ui] || "",
            description:
              AshUIExamples.TimeInput.runtime_description(
                AshUIExamples.TimeInput.default_runtime()
              ),
            mode: :live_fragment,
            runtime: AshUIExamples.TimeInput.default_runtime()
          }
        end)
      ...
      <ExampleShell.example_shell
        ...
        summary={"Meaningful Interaction Story: adjust the time control and confirm the preview stat stays in sync through the resource-owned binding path."}
        theme_css={@theme_css}
      >
    ...
    defp refresh_rendered_ui(socket) do
      rendered_runtime =
        AshUIExamples.TimeInput.rendered_runtime(
          socket.assigns,
          socket.assigns[:example_runtime] || AshUIExamples.TimeInput.default_runtime()
        )
    ...
    defp runtime_from_params(params) do
      params["runtime"]
      |> fallback_runtime()
      |> AshUIExamples.TimeInput.normalize_runtime!()
    end
