...
3. **[DG-0003: Compiler, Canonical IUR, and Renderers](DG-0003-compiler-canonical-iur-and-renderers.md)** - Internal compilation, canonical conversion, and adapter selection.
