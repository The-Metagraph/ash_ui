defmodule UnifiedUi.Dsl.Node do
  ...
  @type t :: %__MODULE__{
          ...
          picker_id: String.t() | nil,
          filters: list() | nil,
          suggestions: list() | nil,
          loading?: boolean() | nil,
          filter_toggle_intent: atom() | nil,
          suggestion_accept_intent: atom() | nil,
          suggestion_dismiss_intent: atom() | nil,
          row_identity: term(),
          column_template: list() | nil,
          active?: boolean() | nil,
          link_target: String.t() | nil,
          meta: term(),
          artifact_kind: atom() | nil,
          status_badges: list() | nil,
          counts: list() | map() | nil,
          timestamp_at: term(),
          steps: list() | nil,
          ...
          stages: list() | nil,
          subject_path: String.t() | nil,
          progress_pct: integer() | float() | nil,
          active_count: integer() | nil,
          blocked_count: integer() | nil,
          last_activity_at: term(),
          depends_on: list() | nil,
          depended_by: list() | nil,
          selected?: boolean() | nil,
          focus_intent: String.t() | nil,
          open_action: map() | nil,
          leading: list() | nil,
          trailing: list() | nil,
  ...
  defstruct __identifier__: nil,
            ...
            suggestions: nil,
            loading?: nil,
            filter_toggle_intent: nil,
            suggestion_accept_intent: nil,
            suggestion_dismiss_intent: nil,
            row_identity: nil,
            column_template: nil,
            active?: nil,
            link_target: nil,
  ...
  def summary(%__MODULE__{} = node) do
    %{
      ...
      picker_id: node.picker_id,
      filters: node.filters,
      suggestions: node.suggestions,
      loading?: node.loading?,
      filter_toggle_intent: node.filter_toggle_intent,
      suggestion_accept_intent: node.suggestion_accept_intent,
      suggestion_dismiss_intent: node.suggestion_dismiss_intent,
      ...
      status_badges: node.status_badges,
      counts: node.counts,
      timestamp_at: node.timestamp_at,
      steps: node.steps,
