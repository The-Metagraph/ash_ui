defmodule Phase20ExampleGenerator do
  ...
  def run(args) do
    definitions =
      case args do
        ...
        sections ->
          ...
          |> Enum.flat_map(&Phase20.definitions_for/1)
      end
    ...
    Enum.each(definitions, fn definition ->
      ...
      project_path = Phase20.project_path(directory)
      root_module = inspect(Phase20.example_module(directory))
      module_basename = directory
      camel_directory = Macro.camelize(directory)
      app_atom = Phase20.app_atom(directory)
  ...
  defp render_readme(definition) do
    ...
    `mix run --no-start -e "IO.puts(#{inspect(Phase20.screen_name(definition.directory))})"`
    """
  end
  ...
  defp render_app_css(shared_theme_css, definition) do
    ...
    .ash-stream-widget-header,
    .ash-process-monitor-header,
    .ash-supervision-tree-viewer-header,
    .ash-cluster-dashboard-header {
      display: grid;
      gap: 0.35rem;
    }

    .ash-stream-widget-title,
    .ash-process-monitor-title,
    .ash-supervision-tree-viewer-title,
    .ash-cluster-dashboard-title {
      color: var(--ashui-example-copy-strong);
      font-size: 1rem;
      margin: 0;
    }

    .ash-stream-widget-description,
    .ash-process-monitor-description,
    .ash-supervision-tree-viewer-description,
    .ash-cluster-dashboard-description {
      color: var(--ashui-example-copy-muted);
      font-size: 0.92rem;
      margin: 0;
    }

    .ash-stream-widget-body,
    .ash-process-monitor-body,
    .ash-supervision-tree-viewer-body,
    .ash-cluster-dashboard-body {
      display: grid;
      gap: 1rem;
    }

    .ash-stream-widget-entries,
    .ash-process-monitor-cards,
    .ash-cluster-dashboard-regions,
    .ash-cluster-dashboard-alerts {
      display: grid;
      gap: 0.75rem;
    }

    .ash-stream-widget-entry,
    .ash-process-monitor-card,
    .ash-cluster-dashboard-region,
    .ash-cluster-dashboard-alert,
    .ash-cluster-dashboard-hero {
      background: rgba(255, 255, 255, 0.04);
      border: 1px solid var(--ashui-example-border-soft);
      border-radius: 1rem;
      display: grid;
    ...
    .ash-stream-widget-time,
    .ash-stream-widget-label,
    .ash-process-monitor-state,
    .ash-process-monitor-meta,
    .ash-supervision-tree-root-meta,
    .ash-supervision-tree-node-meta,
    .ash-cluster-dashboard-region-status,
    .ash-cluster-dashboard-region-load,
    .ash-cluster-dashboard-alert-title {
      color: var(--ashui-example-accent);
      font-size: 0.78rem;
      letter-spacing: 0.08em;
      text-transform: uppercase;
    ...
    .ash-stream-widget-message,
    .ash-process-monitor-summary,
    .ash-cluster-dashboard-detail,
    .ash-cluster-dashboard-alert-message {
      color: var(--ashui-example-copy-muted);
      line-height: 1.65;
      margin: 0;
    }

    .ash-process-monitor-name,
    .ash-supervision-tree-root-label,
    .ash-supervision-tree-node-label,
    .ash-cluster-dashboard-headline,
    .ash-cluster-dashboard-region-label {
      color: var(--ashui-example-copy-strong);
      font-size: 0.95rem;
      font-weight: 700;
      margin: 0;
    ...
    .ash-supervision-tree-root,
    .ash-supervision-tree-node-row {
      align-items: center;
      display: flex;
      flex-wrap: wrap;
      gap: 0.75rem;
    ...
    .ash-stream-widget-actions,
    .ash-process-monitor-actions,
    .ash-supervision-tree-viewer-actions,
    .ash-cluster-dashboard-actions {
      display: flex;
      flex-wrap: wrap;
      gap: 0.75rem;
    }

    .ash-stream-widget-footer,
    .ash-process-monitor-footer,
    .ash-supervision-tree-viewer-footer,
    .ash-cluster-dashboard-footer {
      display: grid;
      gap: 0.6rem;
    }
    ...
    .ash-overlay-surface::before,
    .ash-dialog-surface::before,
    .ash-alert-dialog-surface::before {
    ...
    .ash-overlay-surface.is-closed .ash-overlay-panel,
    .ash-dialog-surface.is-closed .ash-dialog-panel,
    .ash-alert-dialog-surface.is-closed .ash-alert-dialog-panel {
      opacity: 0.78;
    }

    .ash-overlay-header,
    .ash-dialog-header,
    .ash-alert-dialog-header,
    .ash-context-menu-header,
    .ash-toast-header {
      display: grid;
      gap: 0.35rem;
    ...
    .ash-overlay-title,
    .ash-dialog-title,
    .ash-alert-dialog-title,
    .ash-context-menu-title,
    .ash-toast-title {
      color: var(--ashui-example-copy-strong);
      font-size: 1rem;
      margin: 0;
    ...
    .ash-overlay-description,
    .ash-dialog-description,
    .ash-alert-dialog-description,
    .ash-context-menu-description,
    .ash-toast-description {
      color: var(--ashui-example-copy-muted);
      font-size: 0.92rem;
      margin: 0;
    }
    ...
    .ash-overlay-body,
    .ash-dialog-body,
    .ash-alert-dialog-body,
    .ash-context-menu-body,
    .ash-toast-body {
      display: grid;
      gap: 0.9rem;
    }
    ...
    .ash-overlay-footer,
    .ash-dialog-footer,
    .ash-alert-dialog-footer,
    .ash-context-menu-footer,
    .ash-toast-footer {
      display: grid;
      gap: 0.6rem;
      margin-top: 0.85rem;
    ...
    .ash-alert-dialog-panel {
      ...
      box-shadow: 0 1.2rem 3.2rem rgba(255, 122, 61, 0.18);
    }

    .ash-context-menu-items[role="menu"] > * {
      flex: 1 1 12rem;
    }
    ...
    EEx.eval_string(
      ...
      defmodule <%= root_module %> do
        ...
        defmodule Examples.<%= Macro.camelize(definition.directory) %>DemoPanelElement do
          ...
          ui_element do
            type :card
            props %{title: <%= Phase20ExampleGenerator.literal(definition.title) %>, class: "ashui-example-panel"}
        ...
        defmodule Examples.<%= Macro.camelize(definition.directory) %>SubjectElement do
          ...
          ui_element do
            type <%= Phase20ExampleGenerator.literal(definition.subject_type) %>
            props <%= Phase20ExampleGenerator.pretty_literal(definition.subject_props) %>
          ...
          ui_actions do
            action <%= Phase20ExampleGenerator.literal(definition.subject_action.id) %> do
              signal <%= Phase20ExampleGenerator.literal(definition.subject_action.signal) %>
              source %{resource: "ExampleState", action: "update", id: "state-<%= definition.directory %>"}
              target "submit"
              transform %{params: <%= Phase20ExampleGenerator.pretty_literal(definition.subject_action.params) %>}
              metadata <%= Phase20ExampleGenerator.pretty_literal(definition.subject_action.metadata) %>
            end
          end
          <% end %>
        end
        ...
        defmodule Examples.<%= Macro.camelize(definition.directory) %>PreviewElement do
          ...
          ui_element do
            type :stat
            props %{title: <%= Phase20ExampleGenerator.literal(definition.preview_title || "Current value") %>, value: <%= Phase20ExampleGenerator.literal(preview_value) %>}
            variants [:primary]
          ...
          ui_bindings do
            binding :preview_value do
              source %{resource: "ExampleState", field: <%= Phase20ExampleGenerator.literal(definition.preview_field) %>, id: "state-<%= definition.directory %>"}
              target "value"
              binding_type :value
              transform %{}
        ...
        defmodule Examples.<%= Macro.camelize(definition.directory) %>StoryTextElement do
          ...
          ui_element do
            type :text
            props %{content: <%= Phase20ExampleGenerator.literal(definition.story_text) %>, class: "ashui-example-code-surface"}
        ...
        defmodule Examples.<%= Macro.camelize(definition.directory) %>SignalTextElement do
          ...
          ui_element do
            type :text
            props %{content: <%= Phase20ExampleGenerator.literal(definition.signal_text) %>, class: "ashui-example-code-surface"}
        ...
        defmodule Examples.<%= Macro.camelize(definition.directory) %>SupportNoticeElement do
          ...
          ui_element do
            type :text
            props %{content: <%= Phase20ExampleGenerator.literal(definition.support_notice) %>, class: "ashui-example-focus-ring"}
        ...
        defmodule Examples.<%= Macro.camelize(definition.directory) %>Screen do
          ...
          ui_screen do
            layout :column
            route "/"
            metadata %{title: <%= Phase20ExampleGenerator.literal(definition.title) %>, example_directory: <%= Phase20ExampleGenerator.literal(definition.directory) %>, shell_id: "example-<%= definition.directory %>-shell"}
          end
        end
        ...
        defmodule Web.Endpoint do
          use Phoenix.Endpoint, otp_app: <%= Phase20ExampleGenerator.literal(AshUI.Examples.Phase20.app_atom(definition.directory)) %>
  ...
  defp try_it_text(%{directory: "overlay"}) do
  ...
  defp try_it_text(%{directory: directory}) when directory in ["dialog", "alert_dialog"] do
  ...
  defp try_it_text(%{directory: "context_menu"}) do
...
Phase20ExampleGenerator.run(System.argv())
