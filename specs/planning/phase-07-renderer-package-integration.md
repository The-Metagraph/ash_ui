...
[X] 7 Phase 7 - Renderer Package Integration
  Integrate with external unified renderer packages (live_ui, elm_ui, desktop_ui) for final output generation.
  ...
  [X] 7.1 Section - Package Dependencies
    ...
    Include renderer packages as optional dependencies.
      ...
      [X] - Add `elm_ui` as optional dependency
  ...
  [X] 7.3 Section - ElmUI Integration
    Integrate with elm_ui renderer for Elm-backed web output.
    ...
    [X] - Handle ElmUI-specific features
    Support ElmUI-specific rendering features.
  ...
  [X] 7.5 Section - Renderer Selection
    ...
    Select renderer based on request context.
      ...
      [X] 7.5.1.2 Subtask - Detect HTTP request → use elm_ui
  ...
  [X] 7.6 Section - Phase 7 Integration Tests
    ...
    [X] 7.6.2 Task - ElmUI integration scenarios
    Verify elm_ui renderer works correctly.
    ...
    Verify renderer selection works correctly.
      ...
      [X] 7.6.3.2 Subtask - Verify HTTP request uses elm_ui
