defmodule AshUI.Rendering.DesktopUIAdapterTest do
  ...
  describe "Section 7.4.2 - DesktopUI-specific Features" do
    ...
    test "configure_window/2 generates window configuration" do
      config =
        DesktopUIAdapter.configure_window(%{
          "type" => "screen",
          "id" => "s1",
          "name" => "test",
          "layout" => "column",
    ...
    test "configure_menu_bar/2 generates menu bar configuration" do
      config =
        DesktopUIAdapter.configure_menu_bar(%{
          "type" => "screen",
          "id" => "s1",
          "name" => "test",
          "layout" => "column",
      ...
      file_menu =
        Enum.find(config.items, fn item ->
    ...
    test "configure_menu_bar/2 includes default menu items" do
      ...
      quit_item =
        Enum.find(file_menu[:items], fn item ->
    ...
    test "configure_platform/2 detects platform" do
      config =
        DesktopUIAdapter.configure_platform(%{
          "type" => "screen",
          "id" => "s1",
          "name" => "test",
          "layout" => "column",
    ...
    test "configure_events/2 enables shortcuts by default" do
      config =
        DesktopUIAdapter.configure_events(%{
          "type" => "screen",
          "id" => "s1",
          "name" => "test",
          "layout" => "column",
