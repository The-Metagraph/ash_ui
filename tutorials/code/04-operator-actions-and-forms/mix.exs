defmodule AshUITutorials.OperatorActionsAndForms.MixProject do
  use Mix.Project
  ...
  def application do
    [
      mod: {AshUITutorials.OperatorActionsAndForms.Application, []},
  ...
  defp example_start(args) do
    ...
    Mix.shell().info("Starting tutorial checkpoint with runtime=#{runtime}")
